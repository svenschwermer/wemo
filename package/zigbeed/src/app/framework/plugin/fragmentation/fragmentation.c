...
#if defined(EZSP_HOST) && defined(EZSP_APPLICATION_HAS_ROUTE_RECORD_HANDLER)
...
// Because of the tricky nature of this CLI command, it probably shouldn't be generated...
