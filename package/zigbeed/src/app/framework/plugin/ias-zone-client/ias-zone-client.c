...
extern void zbdTriggerBindReport(EmberNodeId nodeId, int16u zoneType);
...
int zbdIasClientRemoveServer(int8u* ieeeAddress);
//-----------------------------------------------------------------------------
// Functions
                                                       ...
                                                       int16u manufacturerCode)
{
  ...
  if (serverIndex != NO_INDEX) {
    ...
    emberAfCorePrintln("enroll response_code success, serverIndex:%d", serverIndex);
  }
  ...
  zbdTriggerBindReport(emberAfCurrentCommand()->source, zoneType);
...
static int8u addServer(int8u* ieeeAddress)
{
  ...
  emberAfCorePrintln("ias-zone addServer i:%d", i);
...
static void removeServer(int8u* ieeeAddress)
{
  ...
  emberAfCorePrintln("ias-zone removeServer i:%d", index);
}
