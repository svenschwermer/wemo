...
typedef enum {
  EMBER_ZCL_SSWG_TIER_BLOCK_MODE_ACTIVE_BLOCK             = 0x00,
  EMBER_ZCL_SSWG_TIER_BLOCK_MODE_ACTIVE_BLOCK_PRICE_TIER  = 0x01
} EmberAfSswgTierBlockMode;

typedef enum {
  EMBER_ZCL_SSWG_C_O2_UNIT_KILOGRAM_PER_KILOWATT_HOUR  = 0x01,
  EMBER_ZCL_SSWG_C_O2_UNIT_GALLONS_OF_GASOLINE         = 0x02,
  EMBER_ZCL_SSWG_C_O2_UNIT_THERMS_OF_NATURAL_GAS       = 0x03
} EmberAfSswgCO2Unit;

typedef enum {
  EMBER_ZCL_SSWG_CREDIT_PAYMENT_STATUS_PENDING             = 0x00,
  EMBER_ZCL_SSWG_CREDIT_PAYMENT_STATUS_RECEIVED_PAID       = 0x01,
  EMBER_ZCL_SSWG_CREDIT_PAYMENT_STATUS_OVERDUE             = 0x02,
  EMBER_ZCL_SSWG_CREDIT_PAYMENT_STATUS_2_PAYMENTS_OVERDUE  = 0x03,
  EMBER_ZCL_SSWG_CREDIT_PAYMENT_STATUS_3_PAYMENTS_OVERDUE  = 0x04
} EmberAfSswgCreditPaymentStatus;

typedef enum {
  EMBER_ZCL_SSWG_PAYMENT_DISCOUNT_DURATION_CURRENT_BILLING_PERIOD     = 0x00,
  EMBER_ZCL_SSWG_PAYMENT_DISCOUNT_DURATION_CURRENT_CONSOLIDATED_BILL  = 0x01,
  EMBER_ZCL_SSWG_PAYMENT_DISCOUNT_DURATION_ONE_MONTH                  = 0x02,
  EMBER_ZCL_SSWG_PAYMENT_DISCOUNT_DURATION_ONE_QUARTER                = 0x03,
  EMBER_ZCL_SSWG_PAYMENT_DISCOUNT_DURATION_ONE_YEAR                   = 0x04
} EmberAfSswgPaymentDiscountDuration;

typedef enum {
  EMBER_ZCL_SSWG_TARIFF_TYPE_IMPORT_TARIFF             = 0x00,
  EMBER_ZCL_SSWG_TARIFF_TYPE_EXPORT_TARIFF             = 0x01,
  EMBER_ZCL_SSWG_TARIFF_TYPE_IMPORT_AND_EXPORT_TARIFF  = 0x02
} EmberAfSswgTariffType;

typedef enum {
  EMBER_ZCL_SSWG_TARIFF_RESOLUTION_PERIOD_NOT_DEFINED     = 0x00,
  EMBER_ZCL_SSWG_TARIFF_RESOLUTION_PERIOD_BILLING_PERIOD  = 0x01,
  EMBER_ZCL_SSWG_TARIFF_RESOLUTION_PERIOD_ONE_DAY         = 0x02
} EmberAfSswgTariffResolutionPeriod;

typedef enum {
  EMBER_ZCL_SSWG_BLOCK_PERIOD_DURATION_UNITS_MINUTES  = 0x000000,
  EMBER_ZCL_SSWG_BLOCK_PERIOD_DURATION_UNITS_DAYS     = 0x400000,
  EMBER_ZCL_SSWG_BLOCK_PERIOD_DURATION_UNITS_WEEKS    = 0x800000,
  EMBER_ZCL_SSWG_BLOCK_PERIOD_DURATION_UNITS_MONTHS   = 0xC00000
} EmberAfSswgBlockPeriodDurationUnits;

typedef enum {
  EMBER_ZCL_SSWG_BLOCK_PERIOD_CONTROL_PRICE_ACKNOWLEDGEMENT_PRICE_ACKNOWLEDGEMENT_REQUIRED      = 0x00,
  EMBER_ZCL_SSWG_BLOCK_PERIOD_CONTROL_PRICE_ACKNOWLEDGEMENT_PRICE_ACKNOWLEDGEMENT_NOT_REQUIRED  = 0x01
} EmberAfSswgBlockPeriodControlPriceAcknowledgement;

typedef enum {
  EMBER_ZCL_SSWG_PUBLISH_CPP_EVENT_CPP_AUTH_PENDING   = 0x00,
  EMBER_ZCL_SSWG_PUBLISH_CPP_EVENT_CPP_AUTH_ACCEPTED  = 0x01,
  EMBER_ZCL_SSWG_PUBLISH_CPP_EVENT_CPP_AUTH_REJECTED  = 0x02,
  EMBER_ZCL_SSWG_PUBLISH_CPP_EVENT_CPP_AUTH_FORCED    = 0x03
} EmberAfSswgPublishCppEventCppAuth;

typedef enum {
  EMBER_ZCL_SSWG_BILLING_PERIOD_DURATION_UNITS_MINUTES  = 0x000000,
  EMBER_ZCL_SSWG_BILLING_PERIOD_DURATION_UNITS_DAYS     = 0x400000,
  EMBER_ZCL_SSWG_BILLING_PERIOD_DURATION_UNITS_WEEKS    = 0x800000,
  EMBER_ZCL_SSWG_BILLING_PERIOD_DURATION_UNITS_MONTHS   = 0xC00000
} EmberAfSswgBillingPeriodDurationUnits;

typedef enum {
  EMBER_ZCL_SSWG_CPP_EVENT_RESPONSE_CPP_AUTH_ACCEPTED  = 0x01,
  EMBER_ZCL_SSWG_CPP_EVENT_RESPONSE_CPP_AUTH_REJECTED  = 0x02
} EmberAfSswgCppEventResponseCppAuth;

typedef enum {
  EMBER_ZCL_SSWG_BLOCK_NO_BLOCKS_IN_USE  = 0x00,
  EMBER_ZCL_SSWG_BLOCK_BLOCK1            = 0x01,
  EMBER_ZCL_SSWG_BLOCK_BLOCK2            = 0x02,
  EMBER_ZCL_SSWG_BLOCK_BLOCK3            = 0x03,
  EMBER_ZCL_SSWG_BLOCK_BLOCK4            = 0x04,
  EMBER_ZCL_SSWG_BLOCK_BLOCK5            = 0x05,
  EMBER_ZCL_SSWG_BLOCK_BLOCK6            = 0x06,
  EMBER_ZCL_SSWG_BLOCK_BLOCK7            = 0x07,
  EMBER_ZCL_SSWG_BLOCK_BLOCK8            = 0x08,
  EMBER_ZCL_SSWG_BLOCK_BLOCK9            = 0x09,
  EMBER_ZCL_SSWG_BLOCK_BLOCK10           = 0x0A,
  EMBER_ZCL_SSWG_BLOCK_BLOCK11           = 0x0B,
  EMBER_ZCL_SSWG_BLOCK_BLOCK12           = 0x0C,
  EMBER_ZCL_SSWG_BLOCK_BLOCK13           = 0x0D,
  EMBER_ZCL_SSWG_BLOCK_BLOCK14           = 0x0E,
  EMBER_ZCL_SSWG_BLOCK_BLOCK15           = 0x0F,
  EMBER_ZCL_SSWG_BLOCK_BLOCK16           = 0x10
} EmberAfSswgBlock;

typedef enum {
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_ELECTRIC_METERING                             = 0x00,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_GAS_METERING                                  = 0x01,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_WATER_METERING                                = 0x02,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_THERMAL_METERING                              = 0x03,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_PRESSURE_METERING                             = 0x04,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_HEAT_METERING                                 = 0x05,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_COOLING_METERING                              = 0x06,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_ELECTRIC_VEHICLE_CHARGING_METERING            = 0x07,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_PV_GENERATION_METERING                        = 0x08,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_WIND_TURBINE_GENERATION_METERING              = 0x09,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_WATER_TURBINE_GENERATION_METERING             = 0x0A,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MICRO_GENERATION_METERING                     = 0x0B,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_SOLAR_HOT_WATER_GENERATION_METERING           = 0x0C,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_GAS_METERING                         = 0x80,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_WATER_METERING                       = 0x81,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_THERMAL_METERING                     = 0x82,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_PRESSURE_METERING                    = 0x83,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_HEAT_METERING                        = 0x84,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_COOLING_METERING                     = 0x85,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_ELECTRIC_VEHICLE_CHARGING_METERING   = 0x86,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_PV_GENERATION_METERING               = 0x87,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_WIND_TURBINE_GENERATION_METERING     = 0x88,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_WATER_TURBINE_GENERATION_METERING    = 0x89,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_MICRO_GENERATION_METERING            = 0x8A,
  EMBER_ZCL_SSWG_METERING_DEVICE_TYPE_MIRRORED_SOLAR_HOT_WATER_GENERATION_METERING  = 0x8B
} EmberAfSswgMeteringDeviceType;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_CHECK_METER                      = 0x00,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_LOW_BATTERY                      = 0x01,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_TAMPER_DETECT                    = 0x02,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_LEAK_DETECT                      = 0x05,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_SERVICE_DISCONNECT               = 0x06,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_METER_COVER_REMOVED              = 0x08,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_STRONG_MAGNETIC_FIELD_DETECTED   = 0x09,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_BATTERY_FAILURE                  = 0x0A,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_PROGRAM_MEMORY_ERROR             = 0x0B,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_RAM_ERROR                        = 0x0C,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_NV_MEMORY_ERROR                  = 0x0D,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_MEASUREMENT_SYSTEM_ERROR         = 0x0E,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_WATCHDOG_ERROR                   = 0x0F,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_SUPPLY_DISCONNECT_FAILURE        = 0x10,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_SUPPLY_CONNECT_FAILURE           = 0x11,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_MEASUREMENT_SW_CHANGED_TAMPERED  = 0x12,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_DAY_LIGHT_SAVING_ENABLED         = 0x13,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_CLOCK_INVALID                    = 0x14,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_COMMUNICATIONS_TAMPER            = 0x15
} EmberAfSswgGenericAlarmGroups;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_ELECTRICITY_POWER_FAILURE  = 0x03,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_ELECTRICITY_POWER_QUALITY  = 0x04
} EmberAfSswgGenericAlarmGroupsElectricity;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_HEAT_COOLING_TEMPERATURE_SENSOR  = 0x03,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_HEAT_COOLING_BURST_DETECT        = 0x04,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_HEAT_COOLING_FLOW_SENSOR         = 0x07
} EmberAfSswgGenericAlarmGroupsHeatCooling;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_GAS_LOW_PRESSURE  = 0x04,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_GAS_REVERSE_FLOW  = 0x07
} EmberAfSswgGenericAlarmGroupsGas;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_WATER_WATER_PIPE_EMPTY    = 0x03,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_WATER_WATER_LOW_PRESSURE  = 0x04,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUPS_WATER_WATER_REVERSE_FLOW  = 0x07
} EmberAfSswgGenericAlarmGroupsWater;

typedef enum {
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_LOW_VOLTAGE_L1            = 0x40,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_HIGH_VOLTAGE_L1           = 0x41,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_LOW_VOLTAGE_L2            = 0x42,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_HIGH_VOLTAGE_L2           = 0x43,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_LOW_VOLTAGE_L3            = 0x44,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_HIGH_VOLTAGE_L3           = 0x45,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_OVER_CURRENT_L1           = 0x46,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_OVER_CURRENT_L2           = 0x47,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_OVER_CURRENT_L3           = 0x48,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_FREQUENCY_TOO_LOW_L1      = 0x49,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_FREQUENCY_TOO_HIGH_L1     = 0x4A,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_FREQUENCY_TOO_LOW_L2      = 0x4B,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_FREQUENCY_TOO_HIGH_L2     = 0x4C,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_FREQUENCY_TOO_LOW_L3      = 0x4D,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_FREQUENCY_TOO_HIGH_L3     = 0x4E,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_GROUND_FAULT              = 0x4F,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_ELECTRIC_TAMPER_DETECT    = 0x50,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_TERMINAL_COVER_REMOVED    = 0x51,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_INCORRECT_POLARITY        = 0x52,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_CURRENT_WITH_NO_VOLTAGE   = 0x53,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_LIMIT_THRESHOLD_EXCEEDED  = 0x54,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_UNDER_VOLTAGE             = 0x55,
  EMBER_ZCL_SSWG_ELECTRICITY_ALARM_GROUPS_OVER_VOLTAGE              = 0x56
} EmberAfSswgElectricityAlarmGroups;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_BURST_DETECT                     = 0x70,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_PRESSURE_TOO_LOW                 = 0x71,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_PRESSURE_TOO_HIGH                = 0x72,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_FLOW_SENSOR_COMMUNICATION_ERROR  = 0x73,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_FLOW_SENSOR_MEASUREMENT_FAULT    = 0x74,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_FLOW_SENSOR_REVERSE_FLOW         = 0x75,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_FLOW_SENSOR_AIR_DETECT           = 0x76,
  EMBER_ZCL_SSWG_GENERIC_FLOW_PRESSURE_ALARM_GROUPS_PIPE_EMPTY                       = 0x77
} EmberAfSswgGenericFlowPressureAlarmGroups;

typedef enum {
  EMBER_ZCL_SSWG_HEAT_AND_COOLING_SPECIFIC_ALARM_GROUPS_INLET_TEMPERATURE_SENSOR_FAULT   = 0x90,
  EMBER_ZCL_SSWG_HEAT_AND_COOLING_SPECIFIC_ALARM_GROUPS_OUTLET_TEMPERATURE_SENSOR_FAULT  = 0x91
} EmberAfSswgHeatAndCoolingSpecificAlarmGroups;

typedef enum {
  EMBER_ZCL_SSWG_GAS_SPECIFIC_ALARM_GROUPS_BATTERY_COVER_REMOVED  = 0xA0,
  EMBER_ZCL_SSWG_GAS_SPECIFIC_ALARM_GROUPS_TILT_TAMPER            = 0xA1,
  EMBER_ZCL_SSWG_GAS_SPECIFIC_ALARM_GROUPS_EXCESS_FLOW            = 0xA2
} EmberAfSswgGasSpecificAlarmGroups;

typedef enum {
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_A  = 0xF0,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_B  = 0xF1,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_C  = 0xF2,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_D  = 0xF3,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_E  = 0xF4,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_F  = 0xF5,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_G  = 0xF6,
  EMBER_ZCL_SSWG_MANUFACTURER_SPECIFIC_ALARM_GROUPS_MANUFACTURER_SPECIFIC_EXTENDED_STATUS_FLAG_H  = 0xF7
} EmberAfSswgManufacturerSpecificAlarmGroups;

typedef enum {
  EMBER_ZCL_SSWG_CHANGE_REPORTING_PROFILE_UNITS_MINUTES  = 0x000000,
  EMBER_ZCL_SSWG_CHANGE_REPORTING_PROFILE_UNITS_DAYS     = 0x400000,
  EMBER_ZCL_SSWG_CHANGE_REPORTING_PROFILE_UNITS_WEEKS    = 0x800000,
  EMBER_ZCL_SSWG_CHANGE_REPORTING_PROFILE_UNITS_MONTHS   = 0xC00000
} EmberAfSswgChangeReportingProfileUnits;

typedef enum {
  EMBER_ZCL_SSWG_SNAPSHOT_PAYLOAD_TYPE_DEBT_CREDIT_ADDITION                               = 0x00,
  EMBER_ZCL_SSWG_SNAPSHOT_PAYLOAD_TYPE_CURRENT_SUMMATION_DELIVERED_AND_RECEIVED_REGISTER  = 0x01,
  EMBER_ZCL_SSWG_SNAPSHOT_PAYLOAD_TYPE_TOU_INFORMATION_SET_DELIVERED_REGISTERS            = 0x02,
  EMBER_ZCL_SSWG_SNAPSHOT_PAYLOAD_TYPE_TOU_INFORMATION_SET_RECEIVED_REGISTERS             = 0x03,
  EMBER_ZCL_SSWG_SNAPSHOT_PAYLOAD_TYPE_BLOCK_INFORMATION_SET_DELIVERED                    = 0x04,
  EMBER_ZCL_SSWG_SNAPSHOT_PAYLOAD_TYPE_BLOCK_INFORMATION_SET_RECEIVED                     = 0x05
} EmberAfSswgSnapshotPayloadType;

typedef enum {
  EMBER_ZCL_SSWG_DEBT_RECOVERY_METHOD_TIME_BASED      = 0x00,
  EMBER_ZCL_SSWG_DEBT_RECOVERY_METHOD_BALANCE_BASED   = 0x01,
  EMBER_ZCL_SSWG_DEBT_RECOVERY_METHOD_CATCH_UP_BASED  = 0x02
} EmberAfSswgDebtRecoveryMethod;

typedef enum {
  EMBER_ZCL_SSWG_RECOVERY_FREQUENCY_FIELD_PER_HOUR     = 0x00,
  EMBER_ZCL_SSWG_RECOVERY_FREQUENCY_FIELD_PER_DAY      = 0x01,
  EMBER_ZCL_SSWG_RECOVERY_FREQUENCY_FIELD_PER_WEEK     = 0x02,
  EMBER_ZCL_SSWG_RECOVERY_FREQUENCY_FIELD_PER_MONTH    = 0x03,
  EMBER_ZCL_SSWG_RECOVERY_FREQUENCY_FIELD_PER_QUARTER  = 0x04
} EmberAfSswgRecoveryFrequencyField;

typedef enum {
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUP_LOW_CREDIT                  = 0x00,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUP_NO_CREDIT_ZERO_CREDIT       = 0x01,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUP_CREDIT_EXHAUSTED            = 0x02,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUP_EMERGENCY_CREDIT_ENABLED    = 0x03,
  EMBER_ZCL_SSWG_GENERIC_ALARM_GROUP_EMERGENCY_CREDIT_EXHAUSTED  = 0x04
} EmberAfSswgGenericAlarmGroup;

typedef enum {
  EMBER_ZCL_SSWG_PREPAY_SWITCH_ALARM_GROUP_SUPPLY_ON                                      = 0x10,
  EMBER_ZCL_SSWG_PREPAY_SWITCH_ALARM_GROUP_SUPPLY_ARM                                     = 0x11,
  EMBER_ZCL_SSWG_PREPAY_SWITCH_ALARM_GROUP_SUPPLY_OFF                                     = 0x12,
  EMBER_ZCL_SSWG_PREPAY_SWITCH_ALARM_GROUP_DISCONNECTION_FAILURE_SHUT_OFF_MECHANISM_FAIL  = 0x13,
  EMBER_ZCL_SSWG_PREPAY_SWITCH_ALARM_GROUP_DISCONNECTED_DUE_TO_TAMPER_DETECTED            = 0x14,
  EMBER_ZCL_SSWG_PREPAY_SWITCH_ALARM_GROUP_REMOTE_DISCONNECTED                            = 0x15
} EmberAfSswgPrepaySwitchAlarmGroup;

typedef enum {
  EMBER_ZCL_SSWG_PREPAY_EVENT_ALARM_GROUP_PHYSICAL_ATTACK_ON_THE_PREPAY_METER    = 0x20,
  EMBER_ZCL_SSWG_PREPAY_EVENT_ALARM_GROUP_ELECTRONIC_ATTACK_ON_THE_PREPAY_METER  = 0x21,
  EMBER_ZCL_SSWG_PREPAY_EVENT_ALARM_GROUP_DISCOUNT_APPLIED                       = 0x22
} EmberAfSswgPrepayEventAlarmGroup;

typedef enum {
  EMBER_ZCL_SSWG_ORIGINATING_DEVICE_ENERGY_SERVICE_INTERFACE    = 0x00,
  EMBER_ZCL_SSWG_ORIGINATING_DEVICE_METER                       = 0x01,
  EMBER_ZCL_SSWG_ORIGINATING_DEVICE_IN_PREMISES_DISPLAY_DEVICE  = 0x02
} EmberAfSswgOriginatingDevice;

typedef enum {
  EMBER_ZCL_SSWG_CHANGE_DEBT_DEBT_TYPE_TYPE1_ABSOLUTE     = 0x00,
  EMBER_ZCL_SSWG_CHANGE_DEBT_DEBT_TYPE_TYPE1_INCREMENTAL  = 0x01,
  EMBER_ZCL_SSWG_CHANGE_DEBT_DEBT_TYPE_TYPE2_ABSOLUTE     = 0x02,
  EMBER_ZCL_SSWG_CHANGE_DEBT_DEBT_TYPE_TYPE2_INCREMENTAL  = 0x03,
  EMBER_ZCL_SSWG_CHANGE_DEBT_DEBT_TYPE_TYPE3_ABSOLUTE     = 0x04,
  EMBER_ZCL_SSWG_CHANGE_DEBT_DEBT_TYPE_TYPE3_INCREMENTAL  = 0x05
} EmberAfSswgChangeDebtDebtType;

typedef enum {
  EMBER_ZCL_SSWG_CREDIT_ADJUSTMENT_TYPE_CREDIT_INCREMENTAL  = 0x00,
  EMBER_ZCL_SSWG_CREDIT_ADJUSTMENT_TYPE_CREDIT_ABSOLUTE     = 0x01
} EmberAfSswgCreditAdjustmentType;

typedef enum {
  EMBER_ZCL_SSWG_GET_DEBT_REPAYMENTY_LOG_DEBT_TYPE_DEBT1  = 0x00,
  EMBER_ZCL_SSWG_GET_DEBT_REPAYMENTY_LOG_DEBT_TYPE_DEBT2  = 0x01,
  EMBER_ZCL_SSWG_GET_DEBT_REPAYMENTY_LOG_DEBT_TYPE_DEBT3  = 0x02
} EmberAfSswgGetDebtRepaymentyLogDebtType;

typedef enum {
  EMBER_ZCL_SSWG_RESULT_TYPE_ACCEPTED                     = 0x00,
  EMBER_ZCL_SSWG_RESULT_TYPE_REJECTED_INVALID_TOP_UP      = 0x01,
  EMBER_ZCL_SSWG_RESULT_TYPE_REJECTED_DUPLICATE_TOP_UP    = 0x02,
  EMBER_ZCL_SSWG_RESULT_TYPE_REJECTED_ERROR               = 0x03,
  EMBER_ZCL_SSWG_RESULT_TYPE_REJECTED_MAX_CREDIT_REACHED  = 0x04,
  EMBER_ZCL_SSWG_RESULT_TYPE_REJECTED_KEYPAD_LOCK         = 0x05
} EmberAfSswgResultType;

typedef enum {
  EMBER_ZCL_SSWG_SOURCE_OF_TOP_UP_IPD    = 0x00,
  EMBER_ZCL_SSWG_SOURCE_OF_TOP_UP_ESI    = 0x01,
  EMBER_ZCL_SSWG_SOURCE_OF_TOP_UP_METER  = 0x02
} EmberAfSswgSourceOfTopUp;

typedef enum {
  EMBER_ZCL_SSWG_CALENDAR_TYPE_DELIVERED_CALENDAR               = 0x00,
  EMBER_ZCL_SSWG_CALENDAR_TYPE_RECEIVED_CALENDAR                = 0x01,
  EMBER_ZCL_SSWG_CALENDAR_TYPE_DELIVERED_AND_RECEIVED_CALENDAR  = 0x02,
  EMBER_ZCL_SSWG_CALENDAR_TYPE_FRIENDLY_CREDIT_CALENDAR         = 0x03,
  EMBER_ZCL_SSWG_CALENDAR_TYPE_AUXILLIARY_LOAD_SWITCH_CALENDAR  = 0x04
} EmberAfSswgCalendarType;

typedef enum {
  EMBER_ZCL_SSWG_CALENDAR_TIME_REFERENCE_STANDARD_TIME  = 0x00,
  EMBER_ZCL_SSWG_CALENDAR_TIME_REFERENCE_LOCAL_TIME     = 0x01
} EmberAfSswgCalendarTimeReference;

typedef enum {
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_DO_NOT_LOG               = 0x00,
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_LOG_IN_TO_TAMPER         = 0x01,
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_LOG_IN_TO_FAULT          = 0x02,
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_LOG_IN_TO_GENERAL_EVENT  = 0x03,
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_LOG_IN_TO_LOG4           = 0x04,
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_LOG_IN_TO_LOG5           = 0x05,
  EMBER_ZCL_SSWG_EVENT_CONFIGURATION_LOG_IN_TO_LOG6           = 0x06
} EmberAfSswgEventConfiguration;

typedef enum {
  EMBER_ZCL_SSWG_SUPPLY_STATUS_SUPPLY_OFF  = 0x00,
  EMBER_ZCL_SSWG_SUPPLY_STATUS_ARMED       = 0x01,
  EMBER_ZCL_SSWG_SUPPLY_STATUS_SUPPLY_ON   = 0x02
} EmberAfSswgSupplyStatus;

typedef enum {
  EMBER_ZCL_SSWG_PASSWORD_LEVEL_PASSWORD1  = 0x01,
  EMBER_ZCL_SSWG_PASSWORD_LEVEL_PASSWORD2  = 0x02,
  EMBER_ZCL_SSWG_PASSWORD_LEVEL_PASSWORD3  = 0x03,
  EMBER_ZCL_SSWG_PASSWORD_LEVEL_PASSWORD4  = 0x04
} EmberAfSswgPasswordLevel;

typedef enum {
  EMBER_ZCL_SSWG_PROPOSED_SUPPLY_STATUS_RESERVED          = 0x00,
  EMBER_ZCL_SSWG_PROPOSED_SUPPLY_STATUS_SUPPLY_OFF_ARMED  = 0x01,
  EMBER_ZCL_SSWG_PROPOSED_SUPPLY_STATUS_SUPPLY_ON         = 0x02
} EmberAfSswgProposedSupplyStatus;

typedef enum {
  EMBER_ZCL_SSWG_EVENT_ID_METER_COVER_REMOVED                    = 0x00,
  EMBER_ZCL_SSWG_EVENT_ID_METER_COVER_CLOSED                     = 0x01,
  EMBER_ZCL_SSWG_EVENT_ID_STRONG_MAGNETIC_FIELD                  = 0x02,
  EMBER_ZCL_SSWG_EVENT_ID_NO_STRONG_MAGNETIC_FIELD               = 0x03,
  EMBER_ZCL_SSWG_EVENT_ID_BATTERY_FAILURE                        = 0x04,
  EMBER_ZCL_SSWG_EVENT_ID_LOW_BATTERY                            = 0x05,
  EMBER_ZCL_SSWG_EVENT_ID_PROGRAM_MEMORY_ERROR                   = 0x06,
  EMBER_ZCL_SSWG_EVENT_ID_RAM_ERROR                              = 0x07,
  EMBER_ZCL_SSWG_EVENT_ID_NV_MEMORY_ERROR                        = 0x08,
  EMBER_ZCL_SSWG_EVENT_ID_MEASUREMENT_SYSTEM_ERROR               = 0x09,
  EMBER_ZCL_SSWG_EVENT_ID_WATCHDOG_ERROR                         = 0x0A,
  EMBER_ZCL_SSWG_EVENT_ID_SUPPLY_DISCONNECT_FAILURE              = 0x0B,
  EMBER_ZCL_SSWG_EVENT_ID_SUPPLY_CONNECT_FAILURE                 = 0x0C,
  EMBER_ZCL_SSWG_EVENT_ID_MEASURMENT_SOFTWARE_CHANGED            = 0x0D,
  EMBER_ZCL_SSWG_EVENT_ID_DST_ENABLED                            = 0x0E,
  EMBER_ZCL_SSWG_EVENT_ID_DST_DISABLED                           = 0x0F,
  EMBER_ZCL_SSWG_EVENT_ID_CLOCK_ADJ_BACKWARD                     = 0x10,
  EMBER_ZCL_SSWG_EVENT_ID_CLOCK_ADJ_FORWARD                      = 0x11,
  EMBER_ZCL_SSWG_EVENT_ID_CLOCK_INVALID                          = 0x12,
  EMBER_ZCL_SSWG_EVENT_ID_COMMS_ERROR_HAN                        = 0x13,
  EMBER_ZCL_SSWG_EVENT_ID_COMMS_OK_HAN                           = 0x14,
  EMBER_ZCL_SSWG_EVENT_ID_FRAUD_ATTEMPT                          = 0x15,
  EMBER_ZCL_SSWG_EVENT_ID_POWER_LOSS                             = 0x16,
  EMBER_ZCL_SSWG_EVENT_ID_INCORRECT_PROTOCOL                     = 0x17,
  EMBER_ZCL_SSWG_EVENT_ID_UNUSUAL_HAN_TRAFFIC                    = 0x18,
  EMBER_ZCL_SSWG_EVENT_ID_UNEXPECTED_CLOCK_CHANGE                = 0x19,
  EMBER_ZCL_SSWG_EVENT_ID_COMMS_USING_UNAUTHENTICATED_COMPONENT  = 0x1A,
  EMBER_ZCL_SSWG_EVENT_ID_ERROR_REG_CLEAR                        = 0x1B,
  EMBER_ZCL_SSWG_EVENT_ID_ALARM_REG_CLEAR                        = 0x1C,
  EMBER_ZCL_SSWG_EVENT_ID_UNEXPECTED_HW_RESET                    = 0x1D,
  EMBER_ZCL_SSWG_EVENT_ID_UNEXPECTED_PROGRAM_EXECUTION           = 0x1E,
  EMBER_ZCL_SSWG_EVENT_ID_EVENT_LOG_CLEARED                      = 0x1F,
  EMBER_ZCL_SSWG_EVENT_ID_MANUAL_DISCONNECT                      = 0x20,
  EMBER_ZCL_SSWG_EVENT_ID_MANUAL_CONNECT                         = 0x21,
  EMBER_ZCL_SSWG_EVENT_ID_REMOTE_DISCONNECTION                   = 0x22,
  EMBER_ZCL_SSWG_EVENT_ID_LOCAL_DISCONNECTION                    = 0x23,
  EMBER_ZCL_SSWG_EVENT_ID_LIMIT_THRESHOLD_EXCEEDED               = 0x24,
  EMBER_ZCL_SSWG_EVENT_ID_LIMIT_THRESHOLD_OK                     = 0x25,
  EMBER_ZCL_SSWG_EVENT_ID_LIMIT_THRESHOLD_CHANGED                = 0x26,
  EMBER_ZCL_SSWG_EVENT_ID_MAXIMUM_DEMAND_EXCEEDED                = 0x27,
  EMBER_ZCL_SSWG_EVENT_ID_PROFILE_CLEARED                        = 0x28,
  EMBER_ZCL_SSWG_EVENT_ID_FIRMWARE_READY_FOR_ACTIVATION          = 0x29,
  EMBER_ZCL_SSWG_EVENT_ID_FIRMWARE_ACTIVATED                     = 0x2A,
  EMBER_ZCL_SSWG_EVENT_ID_PATCH_FAILURE                          = 0x2B,
  EMBER_ZCL_SSWG_EVENT_ID_TOU_TARIFF_ACTIVATION                  = 0x2C,
  EMBER_ZCL_SSWG_EVENT_ID_8X8_TARIFFACTIVATED                    = 0x2D,
  EMBER_ZCL_SSWG_EVENT_ID_SINGLE_TARIFF_RATE_ACTIVATED           = 0x2E,
  EMBER_ZCL_SSWG_EVENT_ID_ASYNCHRONOUS_BILLING_OCCURRED          = 0x2F,
  EMBER_ZCL_SSWG_EVENT_ID_SYNCHRONOUS_BILLING_OCCURRED           = 0x30,
  EMBER_ZCL_SSWG_EVENT_ID_INCORRECT_POLARITY                     = 0x80,
  EMBER_ZCL_SSWG_EVENT_ID_CURRENT_NO_VOLTAGE                     = 0x81,
  EMBER_ZCL_SSWG_EVENT_ID_UNDER_VOLTAGE                          = 0x82,
  EMBER_ZCL_SSWG_EVENT_ID_OVER_VOLTAGE                           = 0x83,
  EMBER_ZCL_SSWG_EVENT_ID_NORMAL_VOLTAGE                         = 0x84,
  EMBER_ZCL_SSWG_EVENT_ID_PF_BELOW_THRESHOLD                     = 0x85,
  EMBER_ZCL_SSWG_EVENT_ID_PF_ABOVE_THRESHOLD                     = 0x86,
  EMBER_ZCL_SSWG_EVENT_ID_TERMINAL_COVER_REMOVED                 = 0x87,
  EMBER_ZCL_SSWG_EVENT_ID_TERMINAL_COVER_CLOSED                  = 0x88,
  EMBER_ZCL_SSWG_EVENT_ID_REVERSE_FLOW                           = 0xA0,
  EMBER_ZCL_SSWG_EVENT_ID_TILT_TAMPER                            = 0xA1,
  EMBER_ZCL_SSWG_EVENT_ID_BATTERY_COVER_REMOVED                  = 0xA2,
  EMBER_ZCL_SSWG_EVENT_ID_BATTERY_COVER_CLOSED                   = 0xA3,
  EMBER_ZCL_SSWG_EVENT_ID_EXCESS_FLOW                            = 0xA4,
  EMBER_ZCL_SSWG_EVENT_ID_EMERGENCY_CREDIT_IN_USE                = 0xC0,
  EMBER_ZCL_SSWG_EVENT_ID_EMERGENCY_CREDIT_EXHAUSTED             = 0xC1,
  EMBER_ZCL_SSWG_EVENT_ID_ZERO_CREDIT_EC_NOT_SELECTED            = 0xC2,
  EMBER_ZCL_SSWG_EVENT_ID_SUPPLY_ON                              = 0xC3,
  EMBER_ZCL_SSWG_EVENT_ID_SUPPLY_OFF_AARMED                      = 0xC4,
  EMBER_ZCL_SSWG_EVENT_ID_SUPPLY_OFF                             = 0xC5,
  EMBER_ZCL_SSWG_EVENT_ID_DISCOUNT_APPLIED                       = 0xC6,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_A                = 0xE0,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_B                = 0xE1,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_C                = 0xE2,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_D                = 0xE3,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_E                = 0xE4,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_F                = 0xE5,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_G                = 0xE6,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_H                = 0xE7,
  EMBER_ZCL_SSWG_EVENT_ID_MANUFACTURER_SPECIFIC_I                = 0xE8
} EmberAfSswgEventId;
