 ...
 */
boolean emberAfAlarmClusterSswgPublishEventLogCallback(int8u commandIndex,
                                                       int8u totalCommands,
                                                       int8u* logPayload);
/** @brief Sswg Get Event Log
 *
 *
 ...
 */
boolean emberAfAlarmClusterSswgGetEventLogCallback(int8u logId,
                                                   int8u eventGroupId,
                                                   int8u eventId,
                                                   int32u startTime,
                                                   int32u endTime,
...
/** @brief Server Pre Attribute Changed
 *
 * Thermostat User Interface Configuration cluster, Server Pre Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute to be changed  Ver.: always
...
/** @brief Client Pre Attribute Changed
 *
 * Thermostat User Interface Configuration cluster, Client Pre Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute to be changed  Ver.: always
...
/** @brief Server Manufacturer Specific Attribute Changed
 *
 * Meter Identification cluster, Server Manufacturer Specific Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
...
/** @brief Client Manufacturer Specific Attribute Changed
 *
 * Meter Identification cluster, Client Manufacturer Specific Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
...
/** @brief Server Manufacturer Specific Attribute Changed
 *
 * Appliance Statistics cluster, Server Manufacturer Specific Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
...
/** @brief Client Manufacturer Specific Attribute Changed
 *
 * Appliance Statistics cluster, Client Manufacturer Specific Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
...
void emberAfSimpleMeteringClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                           ...
                                                           int8u * message,
                                                           EmberStatus status);
/** @brief Sswg Get Snapshot Response
 *
 *
 * @param issuerEventId   Ver.: always
 ...
 */
boolean emberAfSimpleMeteringClusterSswgGetSnapshotResponseCallback(int32u issuerEventId,
                                                                    int32u snapshotTime,
                                                                    int8u commandIndex,
                                                                    int16u snapshotCause,
                                                                    int8u snapshotPayloadType,
                                                                    int8u* snapshotPayload);
/** @brief Sswg Schedule Snapshot Response
 *
 *
 * @param issuerEventId   Ver.: always
 * @param snapshotResponsePayload   Ver.: always
 */
boolean emberAfSimpleMeteringClusterSswgScheduleSnapshotResponseCallback(int32u issuerEventId,
                                                                         int8u* snapshotResponsePayload);
/** @brief Sswg Get Snapshot
 *
 *
 * @param startTime   Ver.: always
 ...
 * @param snapshotCause   Ver.: always
 */
boolean emberAfSimpleMeteringClusterSswgGetSnapshotCallback(int32u startTime,
                                                            int8u numberOfSnapshots,
                                                            int16u snapshotCause);
/** @brief Sswg Take Snapshot
 *
 *
 */
boolean emberAfSimpleMeteringClusterSswgTakeSnapshotCallback(void);
/** @brief Sswg Mirror Report Attribute Response
 *
 *
 * @param notificationFlags   Ver.: always
 * @param priceNotificationFlags   Ver.: always
 * @param calendarNotificationFlags   Ver.: always
 * @param prePayNotificationFlags   Ver.: always
 * @param deviceManagementNotificationFlags   Ver.: always
 */
boolean emberAfSimpleMeteringClusterSswgMirrorReportAttributeResponseCallback(int8u notificationFlags,
                                                                              int16u priceNotificationFlags,
                                                                              int8u calendarNotificationFlags,
                                                                              int16u prePayNotificationFlags,
                                                                              int8u deviceManagementNotificationFlags);
/** @brief Sswg Schedule Snapshot
 *
 *
 * @param issuerEventId   Ver.: always
 * @param commandIndex   Ver.: always
 * @param snapshotPayload   Ver.: always
 */
boolean emberAfSimpleMeteringClusterSswgScheduleSnapshotCallback(int32u issuerEventId,
                                                                 int8u commandIndex,
                                                                 int8u* snapshotPayload);
 ...
 * @param numberOfEvents   Ver.: always
 */
boolean emberAfPriceClusterGetConversionFactorCallback(int32u startTime,
                                                       int8u numberOfEvents);
 ...
 * @param numberOfEvents   Ver.: always
 */
boolean emberAfPriceClusterGetCalorificValueCallback(int32u startTime,
                                                     int8u numberOfEvents);
/** @brief Server Init
 *
...
void emberAfPriceClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                  ...
                                                  int8u * message,
                                                  EmberStatus status);
/** @brief Sswg Publish Block Period
 *
 *
 * @param providerId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 * @param tariffResolutionPeriod   Ver.: always
 */
boolean emberAfPriceClusterSswgPublishBlockPeriodCallback(int32u providerId,
                                                          int32u issuerEventId,
                                                          int32u blockPeriodStartTime,
...
/** @brief Sswg Publish Tariff Information
 *
 *
 ...
 * @param blockThresholdMask   Ver.: always
 * @param blockThresholdMultiplier   Ver.: always
 * @param blockThresholdDivisor   Ver.: always
 */
boolean emberAfPriceClusterSswgPublishTariffInformationCallback(int32u supplierId,
 ...
 * @param issuerTariffId   Ver.: always
 * @param commandIndex   Ver.: always
 * @param tierBlockPrices   Ver.: always
 * @param testPostArrayTimotej   Ver.: always
 */
boolean emberAfPriceClusterSswgPublishPriceMatrixCallback(int32u issuerEventId,
                                                          int32u startTime,
                                                          int32u issuerTariffId,
                                                          int8u commandIndex,
                                                          int8u* tierBlockPrices,
                                                          int8u testPostArrayTimotej);
/** @brief Sswg Publish Block Threshold
 *
 *
 * @param issuerEventId   Ver.: always
 * @param startTime   Ver.: always
 * @param issuerTariffId   Ver.: always
 * @param commandIndex   Ver.: always
 * @param blockThresholds   Ver.: always
 */
boolean emberAfPriceClusterSswgPublishBlockThresholdCallback(int32u issuerEventId,
                                                             int32u startTime,
                                                             int32u issuerTariffId,
                                                             int8u commandIndex,
                                                             int8u* blockThresholds);
/** @brief Sswg Publish C O2 Value
 *
 *
 * @param issuerEventId   Ver.: always
 * @param startTime   Ver.: always
 ...
 */
boolean emberAfPriceClusterSswgPublishCO2ValueCallback(int32u issuerEventId,
                                                       int32u startTime,
                                                       int8u tariffType,
                                                       int32u cO2Value,
                                                       int8u cO2ValueUnit,
                                                       int8u cO2ValueTrailingDigit);
/** @brief Sswg Publish Cpp Event
 *
 *
 * @param issuerEventId   Ver.: always
 * @param startTime   Ver.: always
 ...
 */
boolean emberAfPriceClusterSswgPublishCppEventCallback(int32u issuerEventId,
                                                       int32u startTime,
                                                       int16u durationInMinutes,
                                                       int8u tariffType,
                                                       int8u cppPriceTier,
                                                       int8u cppAuth);
/** @brief Sswg Publish Billing Period
 *
 *
 * @param issuerEventId   Ver.: always
 ...
 * @param tariffType   Ver.: always
 */
boolean emberAfPriceClusterSswgPublishBillingPeriodCallback(int32u issuerEventId,
                                                            int32u billingPeriodStartTime,
                                                            int32u billingPeriodDuration,
                                                            int8u tariffType);
/** @brief Sswg Publish Consolidated Bill
 *
 *
 * @param issuerEventId   Ver.: always
 * @param billingPeriodStartTime   Ver.: always
 ...
 */
boolean emberAfPriceClusterSswgPublishConsolidatedBillCallback(int32u issuerEventId,
                                                               int32u billingPeriodStartTime,
                                                               int32u billingPeriodDuration,
                                                               int8u tariffType,
...
/** @brief Sswg Publish Credit Payment
 *
 *
 * @param issuerEventId   Ver.: always
 ...
 */
boolean emberAfPriceClusterSswgPublishCreditPaymentCallback(int32u issuerEventId,
...
/** @brief Sswg Publish Currency Conversion
 *
 *
 * @param issuerEventId   Ver.: always
 * @param utcTime   Ver.: always
 ...
 * @param signature   Ver.: always
 */
boolean emberAfPriceClusterSswgPublishCurrencyConversionCallback(int32u issuerEventId,
                                                                 int32u utcTime,
                                                                 int16u oldCurrency,
                                                                 int16u newCurrency,
                                                                 int32u conversionFactor,
                                                                 ...
                                                                 int8u signatureType,
                                                                 int8u* signature);
/** @brief Sswg Get Tariff Information
 *
 *
 * @param startTime   Ver.: always
 * @param numberOfEvents   Ver.: always
 * @param tariffType   Ver.: always
 */
boolean emberAfPriceClusterSswgGetTariffInformationCallback(int32u startTime,
                                                            int8u numberOfEvents,
                                                            int8u tariffType);
/** @brief Sswg Get Price Matrix
 *
 *
 * @param issuerTariffId   Ver.: always
 */
boolean emberAfPriceClusterSswgGetPriceMatrixCallback(int32u issuerTariffId);
/** @brief Sswg Get Block Thresholds
 *
 *
 * @param issuerTariffId   Ver.: always
 */
boolean emberAfPriceClusterSswgGetBlockThresholdsCallback(int32u issuerTariffId);
/** @brief Sswg Get C O2 Value
 *
 *
 * @param startTime   Ver.: always
 * @param numberOfEvents   Ver.: always
 * @param tariffType   Ver.: always
 */
boolean emberAfPriceClusterSswgGetCO2ValueCallback(int32u startTime,
                                                   int8u numberOfEvents,
                                                   int8u tariffType);
/** @brief Sswg Get Billing Period
 *
 *
 * @param startTime   Ver.: always
 * @param numberOfEvents   Ver.: always
 * @param tariffType   Ver.: always
 */
boolean emberAfPriceClusterSswgGetBillingPeriodCallback(int32u startTime,
                                                        int8u numberOfEvents,
                                                        int8u tariffType);
/** @brief Sswg Get Consolidated Bill
 *
 *
 * @param startTime   Ver.: always
 * @param numberOfEvents   Ver.: always
 * @param tariffType   Ver.: always
 */
boolean emberAfPriceClusterSswgGetConsolidatedBillCallback(int32u startTime,
                                                           int8u numberOfEvents,
                                                           int8u tariffType);
/** @brief Sswg Cpp Event Response
 *
 *
 * @param issuerEventId   Ver.: always
 * @param cppAuth   Ver.: always
 */
boolean emberAfPriceClusterSswgCppEventResponseCallback(int32u issuerEventId,
                                                        int8u cppAuth);
/** @brief Sswg Get Currency Conversion Command
 *
 *
 * @param issuerEventId   Ver.: always
 */
boolean emberAfPriceClusterSswgGetCurrencyConversionCommandCallback(int32u issuerEventId);
...
void emberAfMessagingClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                      ...
                                                      int8u * message,
                                                      EmberStatus status);
/** @brief Sswg Message Confirmation
 *
 *
 * @param messageId   Ver.: always
 * @param confirmationTime   Ver.: always
 * @param messageConfirmationContral   Ver.: always
 * @param messageResponse   Ver.: always
 */
boolean emberAfMessagingClusterSswgMessageConfirmationCallback(int32u messageId,
                                                               int32u confirmationTime,
 ...
 * @param maximumIncomingTransferSize   Ver.: since se-1.1.1-07-5356-17
 */
...
void emberAfTunnelingClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                      ...
                                                      int8u * message,
                                                      EmberStatus status);
/** @brief Sswg Get Supported Tunnel Protocols
 *
 *
 * @param protocolOffset   Ver.: always
 */
boolean emberAfTunnelingClusterSswgGetSupportedTunnelProtocolsCallback(int8u protocolOffset);
/** @brief Sswg Supported Tunnel Protocols Response
 *
 *
 * @param protocolListComplete   Ver.: always
 * @param protocolCount   Ver.: always
 * @param protocol   Ver.: always
 */
boolean emberAfTunnelingClusterSswgSupportedTunnelProtocolsResponseCallback(int8u protocolListComplete,
                                                                            int8u protocolCount,
                                                                            int8u* protocol);
...
/** @brief Server Manufacturer Specific Attribute Changed
 *
 * 11073 Protocol Tunnel cluster, Server Manufacturer Specific Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
...
/** @brief Client Manufacturer Specific Attribute Changed
 *
 * 11073 Protocol Tunnel cluster, Client Manufacturer Specific Attribute
 * Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
...
/** @brief Sswg Select Available Emergency Credit
 *
 *
 * @param commandIssueDateTime   Ver.: always
 * @param originatingDevice   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgSelectAvailableEmergencyCreditCallback(int32u commandIssueDateTime,
                                                                           int8u originatingDevice);
/** @brief Sswg Change Debt
 *
 *
 * @param commandIssueDateTime   Ver.: always
 ...
 * @param debtRecoveryMaxMissed   Ver.: always
 * @param signatureType   Ver.: always
 * @param signature   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgChangeDebtCallback(int32u commandIssueDateTime,
                                                       int8u* debtLabel,
                                                       int32u debtAmount,
                                                       ...
                                                       int32u debtRecoveryFrequency,
                                                       int32u debtRecoveryAmount,
                                                       int16u debtRecoveryBalancePercentage,
                                                       int8u debtRecoveryMaxMissed,
                                                       int8u signatureType,
                                                       int8u* signature);
/** @brief Sswg Emergency Credit Setup
 *
 *
 * @param issuerEventId   Ver.: always
 * @param commandIssueDateTime   Ver.: always
 ...
 */
boolean emberAfPrepaymentClusterSswgEmergencyCreditSetupCallback(int32u issuerEventId,
                                                                 int32u commandIssueDateTime,
                                                                 int32u emergencyCreditLimit,
                                                                 int32u emergencyCreditThreshold);
/** @brief Sswg Consumer Top Up
 *
 *
 * @param originatingDevice   Ver.: always
 * @param topUpCode   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgConsumerTopUpCallback(int8u originatingDevice,
                                                          int8u* topUpCode);
/** @brief Sswg Credit Adjustment
 *
 *
 * @param issuerEventId   Ver.: always
 * @param startTime   Ver.: always
 ...
 * @param signature   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgCreditAdjustmentCallback(int32u issuerEventId,
                                                             int32u startTime,
                                                             int8u creditAdjustmentType,
                                                             int8u* creditAdjustmentValue,
                                                             int8u signatureType,
                                                             int8u* signature);
/** @brief Sswg Change Payment Mode
 *
 *
 * @param supplierId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 * @param cuttOffValue   Ver.: always
 * @param signatureType   Ver.: always
 * @param signature   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgChangePaymentModeCallback(int32u supplierId,
                                                              int32u issuerEventId,
                                                              ...
                                                              int8u signatureType,
                                                              int8u* signature);
/** @brief Sswg Get Prepay Snapshot
 *
 *
 * @param startTime   Ver.: always
 * @param numberOfSnapshots   Ver.: always
 * @param snapshotCause   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgGetPrepaySnapshotCallback(int32u startTime,
                                                              int8u numberOfSnapshots,
                                                              int16u snapshotCause);
/** @brief Sswg Get Top Up Log
 *
 *
 * @param numberOfEvents   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgGetTopUpLogCallback(int8u numberOfEvents);
/** @brief Sswg Set Low Credit Warning Level
 *
 *
 * @param lowCreditWarningLevel   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgSetLowCreditWarningLevelCallback(int32u lowCreditWarningLevel);
/** @brief Sswg Get Debt Repaymenty Log
 *
 *
 * @param numberOfDebt   Ver.: always
 * @param debtType   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgGetDebtRepaymentyLogCallback(int8u numberOfDebt,
                                                                 int8u debtType);
/** @brief Sswg Get Prepay Snapshot Response
 *
 *
 * @param issuerEventId   Ver.: always
 * @param snapshotTime   Ver.: always
 ...
 * @param snapshotPayload   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgGetPrepaySnapshotResponseCallback(int32u issuerEventId,
                                                                      int32u snapshotTime,
                                                                      int8u commandIndex,
                                                                      int16u snapshotCause,
                                                                      int8u snapshotPayloadType,
                                                                      int8u* snapshotPayload);
/** @brief Sswg Change Payment Mode Response
 *
 *
 ...
 * @param emergencyCreditThreshold   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgChangePaymentModeResponseCallback(int8u friendlyCredit,
                                                                      int32u friendlyCreditCalendarId,
                                                                      int32u emergencyCreditLimit,
                                                                      int32u emergencyCreditThreshold);
/** @brief Sswg Consumer Top Up Response
 *
 *
 ...
 */
boolean emberAfPrepaymentClusterSswgConsumerTopUpResponseCallback(int8u resultType,
                                                                  int32s topUpValue,
                                                                  int8u sourceOfTopUp,
                                                                  int32s creditRemaining);
/** @brief Sswg Get Command
 *
 *
 * @param prePayNotificationFlags   Ver.: always
 */
boolean emberAfPrepaymentClusterSswgGetCommandCallback(int16u prePayNotificationFlags);
/** @brief Sswg Publish Top Up Log
 *
 *
 * @param commandIndex   Ver.: always
 ...
 */
boolean emberAfPrepaymentClusterSswgPublishTopUpLogCallback(int8u commandIndex,
                                                            int8u totalNumberOfCommands,
                                                            int8u* topUpCodes);
/** @brief Sswg Publish Debt Log
 *
 *
 * @param commandIndex   Ver.: always
 * @param totalNumberOfCommands   Ver.: always
 ...
 */
boolean emberAfPrepaymentClusterSswgPublishDebtLogCallback(int8u commandIndex,
                                                           int8u totalNumberOfCommands,
                                                           int8u* debtPayload);
/** @brief Server Init
 *
 ...
 */
boolean emberAfTouCalendarClusterSswgPublishCalendarCallback(int32u providerId,
                                                             int32u issuerEventId,
...
/** @brief Sswg Publish Day Profile
 *
 *
 * @param providerId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 */
boolean emberAfTouCalendarClusterSswgPublishDayProfileCallback(int32u providerId,
                                                               int32u issuerEventId,
                                                               int32u issuerCalendarId,
                                                               int8u dayId,
...
/** @brief Sswg Publish Week Profile
 *
 *
 * @param providerId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 */
boolean emberAfTouCalendarClusterSswgPublishWeekProfileCallback(int32u providerId,
                                                                int32u issuerEventId,
                                                                int32u issuerCalendarId,
                                                                int8u weekId,
 ...
 */
boolean emberAfTouCalendarClusterSswgPublishSeasonsCallback(int32u providerId,
                                                            int32u issuerEventId,
                                                            int32u issuerCalendarId,
                                                            int8u commandIndex,
                                                            int8u totalCommands,
                                                            int8u* seasonEntries);
/** @brief Sswg Publish Special Days
 *
 *
 * @param providerId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 */
boolean emberAfTouCalendarClusterSswgPublishSpecialDaysCallback(int32u providerId,
                                                                int32u issuerEventId,
                                                                int32u startTime,
                                                                int8u calendarType,
...
/** @brief Sswg Get Calendar
 *
 *
 * @param startTime   Ver.: always
 * @param minimumIssuerEventId   Ver.: always
...
/** @brief Sswg Get Change Of Tenancy
 *
 *
 */
boolean emberAfDeviceManagementClusterSswgGetChangeOfTenancyCallback(void);
/** @brief Sswg Get Change Of Supplier
 *
 *
 */
boolean emberAfDeviceManagementClusterSswgGetChangeOfSupplierCallback(void);
/** @brief Sswg Get Change Supply
 *
 *
 */
boolean emberAfDeviceManagementClusterSswgGetChangeSupplyCallback(void);
/** @brief Sswg Supply Status Response
 *
 *
 * @param supplierId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 */
boolean emberAfDeviceManagementClusterSswgSupplyStatusResponseCallback(int32u supplierId,
                                                                       int32u issuerEventId,
                                                                       int32u implementationDateTime,
                                                                       int8u supplyStatus);
/** @brief Sswg Get Password
 *
 *
 * @param passwordLevel   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgGetPasswordCallback(int8u passwordLevel);
/** @brief Sswg Publish Change Of Tenancy
 *
 *
 * @param supplierId   Ver.: always
 * @param issuerEventId   Ver.: always
 ...
 * @param signature   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgPublishChangeOfTenancyCallback(int32u supplierId,
                                                                         int32u issuerEventId,
                                                                         int8u tariffType,
                                                                         int32u implementationDateTime,
                                                                         ...
                                                                         int8u signatureType,
                                                                         int8u* signature);
/** @brief Sswg Publish Change Of Supplier
 *
 *
 ...
 * @param signature   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgPublishChangeOfSupplierCallback(int32u currentSupplierId,
                                                                          int32u issuerEventId,
                                                                          int8u tariffType,
 ...
 * @param signature   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgChangeSupplyCallback(int32u supplierId,
                                                               int32u issuerEventId,
                                                               ...
                                                               int8u signatureType,
                                                               int8u* signature);
/** @brief Sswg Change Password
 *
 *
 * @param passwordLevel   Ver.: always
 * @param password   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgChangePasswordCallback(int8u passwordLevel,
                                                                 int8u* password);
/** @brief Sswg Local Change Supply
 *
 *
 * @param proposedSupplyStatus   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgLocalChangeSupplyCallback(int8u proposedSupplyStatus);
/** @brief Sswg Update Site Id
 *
 *
 * @param issuerEventId   Ver.: always
 ...
 * @param signature   Ver.: always
 */
boolean emberAfDeviceManagementClusterSswgUpdateSiteIdCallback(int32u issuerEventId,
                                                               int32u siteIdTime,
                                                               int32u supplierId,
                                                               int8u* siteId,
                                                               int8u signatureType,
