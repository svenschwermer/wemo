 ...
 * @ingroup cli
 * All the ZCL global commands defined in the ZigBee Cluster Library Specification.
 * These command line commands can be used to send messages over the air to, for
 * instance, read and write attributes to devices on the network.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The Informational command set provides commands for displaying information about
 * the device. These commands include things like printing out the attribute
 * tablerr
 * 
 * @{
 */
...
/** @brief <b>counters </b>
 *   - <i>Prints out values for tracked stack counters</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_INFO_COUNTERS
 ...
 * @ingroup cli
 * The Network command set provides commands for interacting with the network. This
 * includes building as well as sending ZigBee commands out on to the network.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * Commands related to the management of a ZigBee device including device discovery
 * and commissioning.
 * 
 * @{
 */

/** @brief <b>zdo in-cl-list add [clusterIds:-1] </b>
 *   - <i>Add clusters to the known server (in) clusters on this device.</i>
 *     - clusterIds - OCTET_STRING - Array of two byte server cluster ids
 */
 ...
 * Listed below is a description of the cluster:<br><br><i> Commands and attributes
 * required to tunnel the BACnet protocol.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Basic cluster. Listed below is a
 * description of the cluster:<br><br><i> Attributes for determining basic
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Demand Response and Load Control
 * cluster. Listed below is a description of the cluster:<br><br><i> This cluster
 * provides an interface to the functionality of Smart Energy Demand Response and
 * Load Control. Devices targeted by this cluster include thermostats and devices
 * that support load control.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Door Lock cluster. Listed below is
 * a description of the cluster:<br><br><i> Provides an interface into a generic
 * way to secure a door.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Groups cluster. Listed below is a
 * description of the cluster:<br><br><i> Attributes and commands for group
 ...
 * @ingroup cli
 * This group describes the CLI commands for the IAS ACE cluster. Listed below is a
 * description of the cluster:<br><br><i> Attributes and commands for IAS Ancillary
 * Control Equipment.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the IAS Zone cluster. Listed below is
 * a description of the cluster:<br><br><i> Attributes and commands for IAS
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Identify cluster. Listed below is
 * a description of the cluster:<br><br><i> Attributes and commands for putting a
 * device into Identification mode (e.g. flashing a light).</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Messaging cluster. Listed below is
 * a description of the cluster:<br><br><i> This cluster provides an interface for
 * passing text messages between SE devices.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the On/off cluster. Listed below is a
 * description of the cluster:<br><br><i> Attributes and commands for switching
 * devices between 'On' and 'Off' states.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Poll Control cluster. Listed below
 * is a description of the cluster:<br><br><i> This cluster provides a mechanism
 * for the management of an end device's MAC Data Poll rate.  For the purposes of
 * this cluster, the term "poll" always refers to the sending of a MAC Data Poll
 * from the end device to the end device's parent.</i>
 * 
 * @{
 */
 ...
 * transferred can be solicited by client side (request command) or can be notified
 * directly from the device (server side).</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Price cluster. Listed below is a
 * description of the cluster:<br><br><i> The Price Cluster provides the mechanism
 * for communicating Gas, Energy, or Water pricing information within the
 * premise.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Scenes cluster. Listed below is a
 * description of the cluster:<br><br><i> Attributes and commands for scene
 * configuration and manipulation.</i>
 * 
 * @{
 */
 ...
 * below is a description of the cluster:<br><br><i> The Metering Cluster provides
 * a mechanism to retrieve usage information from Electric, Gas, Water, and
 * potentially Thermal metering devices.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Thermostat cluster. Listed below
 * is a description of the cluster:<br><br><i> An interface for configuring and
 * controlling the functionality of a thermostat.</i>
 * 
 * @{
 */
 ...
 * @ingroup cli
 * This group describes the CLI commands for the Tunneling cluster. Listed below is
 * a description of the cluster:<br><br><i> The tunneling cluster provides an
 ...
 * @ingroup cli
 * The drlc plugin contributes CLI commands to the application framework to be used
 * for constructing demand response load control commands.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The drlc-server plugin contributes CLI commands to the application framework to
 * be used for constructing demand response load control commands on the server
 * side.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The End Device Support plugin contributes commands for controlling the sleeping
 * and polling behavior of the device.
 * 
 * @{
 */

/** @brief <b>plugin end-device-support status </b>
 *   - <i>Display the status of the End Device's polling and sleeping.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_END_DEVICE_SUPPORT_PLUGIN_END_DEVICE_SUPPORT_STATUS

/** @brief <b>plugin end-device-support force-awake [stayAwake:1] </b>
 *   - <i>Sets whether the CLI forces the device to stay awake.</i>
 *     - stayAwake - BOOLEAN - The value indicating whether the device should stay awake.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_END_DEVICE_SUPPORT_PLUGIN_END_DEVICE_SUPPORT_FORCE_AWAKE

/** @brief <b>plugin end-device-support awake-when-not-joined [stayAwakeWhenNotJoined:1] </b>
 ...
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_END_DEVICE_SUPPORT_PLUGIN_END_DEVICE_SUPPORT_AWAKE_WHEN_NOT_JOINED
...
/** @addtogroup plugin-gateway-support Plugin Commands: Gateway Support
 * @ingroup cli
 * The gateway support commands provide functionality specific to running a PC host
 * application connected to an Ember chip via EZSP.
 * 
 * @{
 */

/** @brief <b>plugin gateway-support time-sync-local </b>
 *   - <i>This command will sync the ZCL device's local time attribute with the local PC clock.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_GATEWAY_SUPPORT_PLUGIN_GATEWAY_SUPPORT_TIME_SYNC_LOCAL

/** @} */ // end group plugin-gateway-support

/** @addtogroup plugin-groups-server Plugin Commands: Groups Server
 * @ingroup cli
 * The groups server plugin contributes a CLI command to the application framework
 * to be used for printing information related to groups.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The identify plugin contributes a CLI command to the application framework to be
 * used for printing information related to identification.
 * 
 * @{
 */
 ...
 *   - <i>Set the messages message control bit mask to EMBER_ZCL_MESSAGING_CONTROL_TRANSMISSION_NORMAL_AND_ANONYMOUS.</i>
 */
 ...
 * @ingroup cli
 * The Multi-Network Price Passthrough plugin is a plugin designed to demonstrate
 * multi-network functionality by passing data from a "real" ESI on one network to
 * a "proxy" ESI on another network via periodic polling and forwarding.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The OTA Client plugin provides Over-the-air commands for upgrading firmware and
 * downloading specific files on the client side.
 * 
 * @{
 */
...
/** @addtogroup plugin-ota-storage-eeprom Plugin Commands: OTA Storage Common
 * @ingroup cli
 ...
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_OTA_STORAGE_EEPROM_PLUGIN_OTA_STORAGE_EEPROM_WIPE

/** @} */ // end group plugin-ota-storage-eeprom
 ...
 * @ingroup cli
 * The partner link key exchange plugin contributes CLI commands to the application
 * framework to be used for controlling facets of link key exchanges among
 * partners.
 * 
 * @{
 */
 ...
 *   - <i>Clears out the currently set price.</i>
...
/** @brief <b>plugin price-server what [unitOfMeas:1] [curr:2] [ptd:1] [prt:1] </b>
 ...
 *   - <i>Retrieve a price from a given index into the cli's single price buffer for editing</i>
 *     - endpoint - INT8U - the relevant endpoint
 ...
 *   - <i>Print the contents of the price table for the provided endpoint.</i>
 *     - endpoint - INT8U - the relevant endpoint
 */
 ...
 * framework to be used in creating and managing reporting table entries directly
 * on the device.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The Scenes server plugin contributes a CLI command to the application framework
 * to be used for printing information related to scenes.
 * 
 * @{
 */
 ...
 * framework to be used in conjunction with the Simple Metering cluster in a server
 * context
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The Standalone Bootloader Client contributes commands about its current status.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The Standalone Bootloader Server contributes commands to tell client's to launch
 * their standalone bootloader and send them a new application image.
 * 
 * @{
 */
...
/** @addtogroup plugin-tou-calendar-common Plugin Commands: TOU Calendar Common
 * @ingroup cli
 * The TOU calendar common plugin commands provide commands to view and manipulate
 * the local copy of the TOU calendar.
 * 
 * @{
 */

/** @brief <b>plugin tou-calendar-common select </b>
 *   - <i>null</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TOU_CALENDAR_COMMON_PLUGIN_TOU_CALENDAR_COMMON_SELECT

/** @brief <b>plugin tou-calendar-common print summary </b>
 *   - <i>Prints the local TOU calendar summary at the previously selected index.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TOU_CALENDAR_COMMON_PLUGIN_TOU_CALENDAR_COMMON_PRINT_SUMMARY

/** @brief <b>plugin tou-calendar-common print days </b>
 *   - <i>Prints the local TOU calendar's days</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TOU_CALENDAR_COMMON_PLUGIN_TOU_CALENDAR_COMMON_PRINT_DAYS

/** @brief <b>plugin tou-calendar-common print special-days </b>
 *   - <i>Prints the local TOU calendar's special days.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TOU_CALENDAR_COMMON_PLUGIN_TOU_CALENDAR_COMMON_PRINT_SPECIAL_DAYS

/** @brief <b>plugin tou-calendar-common print seasons </b>
 *   - <i>Prints the local TOU calendar's seasons.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TOU_CALENDAR_COMMON_PLUGIN_TOU_CALENDAR_COMMON_PRINT_SEASONS

/** @brief <b>plugin tou-calendar-common test-init </b>
 *   - <i>Initializes a test calendar with dummy data.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TOU_CALENDAR_COMMON_PLUGIN_TOU_CALENDAR_COMMON_TEST_INIT

/** @} */ // end group plugin-tou-calendar-common
 ...
 *   - <i>Corrupts a syngle byte in the cert</i>
 *     - corruptionIndex - INT8U - The EUI64 of the issuer (big endian).
 */
 ...
 * framework CLI. These commands are used for the transfer of data over an opened
 * tunnel.
 * 
 * @{
 */
 ...
 * @ingroup cli
 * The ZigBee Light Link (ZLL) Commissioning Plugin contributes several commands to
 * the application framework's CLI. These commands are used for forming and
...
/** @brief <b>zcl ias-ace b [numberOfZones:1] [zoneIds:1] </b>
...
/** @brief <b>zcl message get </b>
 *   - <i>Command description for GetLastMessage</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_MESSAGING_GET

/** @brief <b>zcl message confirm [messageId:4] [confirmationTime:4] </b>
 *   - <i>Command description for MessageConfirmation</i>
 *     - messageId - INT32U
 *     - confirmationTime - TIME_OF_DAY
 */
 ...
 *   - <i>Command description for GetCurrentPrice</i>
 ...
 *   - <i>Command description for GetScheduledPrices</i>
 *     - startTime - TIME_OF_DAY
 *     - numberOfEvents - INT8U
 */
...
/** @brief <b>zcl power-profile up </b>
