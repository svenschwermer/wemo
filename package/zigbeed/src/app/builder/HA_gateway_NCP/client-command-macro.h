...
/** @brief This command is generated by the metering device on receipt of a Get Event Log Command.
 *
 * Cluster: Alarms, Attributes and commands for sending notifications and configuring alarm functionality.
 * Command: SswgPublishEventLog
 * @param commandIndex int8u
 * @param totalCommands int8u
 * @param logPayload int8u*
 * @param logPayloadLen int16u
 */
#define emberAfFillCommandAlarmClusterSswgPublishEventLog(commandIndex, \
                                                          totalCommands, \
                                                          logPayload, \
                                                          logPayloadLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_ALARM_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_EVENT_LOG_COMMAND_ID, \
                                                "uub", \
                                                commandIndex, \
                                                totalCommands, \
                                                logPayload, \
...
/** @brief The server generates this command when interrogating the event logs.
 *
 * Cluster: Alarms, Attributes and commands for sending notifications and configuring alarm functionality.
 * Command: SswgGetEventLog
 * @param logId int8u
 ...
 */
#define emberAfFillCommandAlarmClusterSswgGetEventLog(logId, \
                                                      eventGroupId, \
                                                      eventId, \
                                                      startTime, \
                                                      endTime, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_ALARM_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_EVENT_LOG_COMMAND_ID, \
                                                "uuuwwu", \
                                                logId, \
                                                eventGroupId, \
                                                eventId, \
 ...
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: SswgGetSnapshotResponse
 * @param issuerEventId int32u
 ...
 */
#define emberAfFillCommandSimpleMeteringClusterSswgGetSnapshotResponse(issuerEventId, \
                                                                       snapshotTime, \
                                                                       commandIndex, \
                                                                       snapshotCause, \
                                                                       snapshotPayloadType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_SIMPLE_METERING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_SNAPSHOT_RESPONSE_COMMAND_ID, \
                                                "wwuvub", \
                                                issuerEventId, \
                                                snapshotTime, \
                                                commandIndex, \
 ...
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: SswgScheduleSnapshotResponse
 * @param issuerEventId int32u
 * @param snapshotResponsePayload int8u*
 * @param snapshotResponsePayloadLen int16u
 */
#define emberAfFillCommandSimpleMeteringClusterSswgScheduleSnapshotResponse(issuerEventId, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_SIMPLE_METERING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_SCHEDULE_SNAPSHOT_RESPONSE_COMMAND_ID, \
                                                "wb", \
                                                issuerEventId, \
                                                snapshotResponsePayload, \
                                                snapshotResponsePayloadLen);
 ...
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: SswgGetSnapshot
 * @param startTime int32u
 * @param numberOfSnapshots int8u
 * @param snapshotCause int16u
 */
#define emberAfFillCommandSimpleMeteringClusterSswgGetSnapshot(startTime, \
                                                               numberOfSnapshots, \
                                                               snapshotCause) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_SIMPLE_METERING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_SNAPSHOT_COMMAND_ID, \
                                                "wuv", \
                                                startTime, \
                                                numberOfSnapshots, \
                                                snapshotCause);
 ...
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: SswgTakeSnapshot
 */
#define emberAfFillCommandSimpleMeteringClusterSswgTakeSnapshot() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_SIMPLE_METERING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_TAKE_SNAPSHOT_COMMAND_ID, \
                                                "");
 ...
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: SswgMirrorReportAttributeResponse
 * @param notificationFlags int8u
 * @param priceNotificationFlags int16u
 * @param calendarNotificationFlags int8u
 * @param prePayNotificationFlags int16u
 * @param deviceManagementNotificationFlags int8u
 */
#define emberAfFillCommandSimpleMeteringClusterSswgMirrorReportAttributeResponse(notificationFlags, \
                                                                                 priceNotificationFlags, \
                                                                                 calendarNotificationFlags, \
                                                                                 prePayNotificationFlags, \
                                                                                 deviceManagementNotificationFlags) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_SIMPLE_METERING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_MIRROR_REPORT_ATTRIBUTE_RESPONSE_COMMAND_ID, \
                                                "uvuvu", \
                                                notificationFlags, \
                                                priceNotificationFlags, \
                                                calendarNotificationFlags, \
 ...
 *
 * Cluster: Simple Metering, The Metering Cluster provides a mechanism to retrieve usage information from Electric, Gas, Water, and potentially Thermal metering devices.
 * Command: SswgScheduleSnapshot
 * @param issuerEventId int32u
 * @param commandIndex int8u
 * @param snapshotPayload int8u*
 * @param snapshotPayloadLen int16u
 */
#define emberAfFillCommandSimpleMeteringClusterSswgScheduleSnapshot(issuerEventId, \
                                                                    commandIndex, \
                                                                    snapshotPayload, \
                                                                    snapshotPayloadLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_SIMPLE_METERING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_SCHEDULE_SNAPSHOT_COMMAND_ID, \
                                                "wub", \
                                                issuerEventId, \
                                                commandIndex, \
                                                snapshotPayload, \
 ...
 * @param numberOfEvents int8u
 */
#define emberAfFillCommandPriceClusterGetConversionFactor(startTime, \
                                                          numberOfEvents) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_PRICE_CLUSTER_ID, \
 ...
 * @param numberOfEvents int8u
 */
#define emberAfFillCommandPriceClusterGetCalorificValue(startTime, \
                                                        numberOfEvents) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_PRICE_CLUSTER_ID, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishBlockPeriod
 * @param providerId int32u
 * @param issuerEventId int32u
 * @param blockPeriodStartTime int32u
 ...
 */
#define emberAfFillCommandPriceClusterSswgPublishBlockPeriod(providerId, \
                                                             issuerEventId, \
                                                             blockPeriodStartTime, \
                                                             blockPeriodDuration, \
                                                             numberOfPriceTiersAndNumberOfBlockThresholds, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_BLOCK_PERIOD_COMMAND_ID, \
                                                "wwwxuuuu", \
                                                providerId, \
                                                issuerEventId, \
                                                blockPeriodStartTime, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishTariffInformation
 ...
 * @param blockThresholdMask int16u
 * @param blockThresholdMultiplier int32u
 * @param blockThresholdDivisor int32u
 */
#define emberAfFillCommandPriceClusterSswgPublishTariffInformation(supplierId, \
                                                                   issuerTariffId, \
                                                                   startTime, \
                                                                   tariffType, \
                                                                   tariffLabel, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_TARIFF_INFORMATION_COMMAND_ID, \
                                                "wwwusuuuvuwuvxx", \
                                                supplierId, \
                                                issuerTariffId, \
                                                startTime, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishPriceMatrix
 * @param issuerEventId int32u
 * @param startTime int32u
 * @param issuerTariffId int32u
 * @param commandIndex int8u
 * @param tierBlockPrices int8u*
 * @param tierBlockPricesLen int16u
 * @param testPostArrayTimotej int8u
 */
#define emberAfFillCommandPriceClusterSswgPublishPriceMatrix(issuerEventId, \
                                                             startTime, \
                                                             issuerTariffId, \
                                                             commandIndex, \
                                                             tierBlockPrices, \
                                                             tierBlockPricesLen, \
                                                             testPostArrayTimotej) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_PRICE_MATRIX_COMMAND_ID, \
                                                "wwwubu", \
                                                issuerEventId, \
                                                startTime, \
                                                issuerTariffId, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishBlockThreshold
 * @param issuerEventId int32u
 * @param startTime int32u
 * @param issuerTariffId int32u
 * @param commandIndex int8u
 * @param blockThresholds int8u*
 * @param blockThresholdsLen int16u
 */
#define emberAfFillCommandPriceClusterSswgPublishBlockThreshold(issuerEventId, \
                                                                startTime, \
                                                                issuerTariffId, \
                                                                commandIndex, \
                                                                blockThresholds, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_BLOCK_THRESHOLD_COMMAND_ID, \
                                                "wwwub", \
                                                issuerEventId, \
                                                startTime, \
                                                issuerTariffId, \
 ...
 */
#define emberAfFillCommandPriceClusterSswgPublishCO2Value(issuerEventId, \
                                                          startTime, \
                                                          tariffType, \
                                                          cO2Value, \
                                                          cO2ValueUnit, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_C_O2_VALUE_COMMAND_ID, \
                                                "wwuwuu", \
                                                issuerEventId, \
                                                startTime, \
                                                tariffType, \
 ...
 * @param cppAuth int8u
 */
#define emberAfFillCommandPriceClusterSswgPublishCppEvent(issuerEventId, \
                                                          startTime, \
                                                          durationInMinutes, \
                                                          tariffType, \
                                                          cppPriceTier, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CPP_EVENT_COMMAND_ID, \
                                                "wwvuuu", \
                                                issuerEventId, \
                                                startTime, \
                                                durationInMinutes, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishBillingPeriod
 * @param issuerEventId int32u
 * @param billingPeriodStartTime int32u
 * @param billingPeriodDuration int32u
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterSswgPublishBillingPeriod(issuerEventId, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_BILLING_PERIOD_COMMAND_ID, \
                                                "wwxu", \
                                                issuerEventId, \
                                                billingPeriodStartTime, \
                                                billingPeriodDuration, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishConsolidatedBill
 * @param issuerEventId int32u
 * @param billingPeriodStartTime int32u
 * @param billingPeriodDuration int32u
 * @param tariffType int8u
 ...
 */
#define emberAfFillCommandPriceClusterSswgPublishConsolidatedBill(issuerEventId, \
                                                                  billingPeriodStartTime, \
                                                                  billingPeriodDuration, \
                                                                  tariffType, \
                                                                  consolidatedBill, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CONSOLIDATED_BILL_COMMAND_ID, \
                                                "wwxuwvu", \
                                                issuerEventId, \
                                                billingPeriodStartTime, \
                                                billingPeriodDuration, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishCreditPayment
 * @param issuerEventId int32u
 ...
 */
#define emberAfFillCommandPriceClusterSswgPublishCreditPayment(issuerEventId, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CREDIT_PAYMENT_COMMAND_ID, \
                                                "wwwuwws", \
                                                issuerEventId, \
                                                creditPaymentDueDate, \
                                                creditPaymentOverDueAmount, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgPublishCurrencyConversion
 * @param issuerEventId int32u
 ...
 * @param signature int8u*
 */
#define emberAfFillCommandPriceClusterSswgPublishCurrencyConversion(issuerEventId, \
                                                                    utcTime, \
                                                                    oldCurrency, \
                                                                    newCurrency, \
                                                                    conversionFactor, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CURRENCY_CONVERSION_COMMAND_ID, \
                                                "wwvvwuwus", \
                                                issuerEventId, \
                                                utcTime, \
                                                oldCurrency, \
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetTariffInformation
 * @param startTime int32u
 * @param numberOfEvents int8u
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterSswgGetTariffInformation(startTime, \
                                                               numberOfEvents, \
                                                               tariffType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_TARIFF_INFORMATION_COMMAND_ID, \
                                                "wuu", \
                                                startTime, \
                                                numberOfEvents, \
                                                tariffType);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetPriceMatrix
 * @param issuerTariffId int32u
 */
#define emberAfFillCommandPriceClusterSswgGetPriceMatrix(issuerTariffId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_PRICE_MATRIX_COMMAND_ID, \
                                                "w", \
                                                issuerTariffId);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetBlockThresholds
 * @param issuerTariffId int32u
 */
#define emberAfFillCommandPriceClusterSswgGetBlockThresholds(issuerTariffId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_BLOCK_THRESHOLDS_COMMAND_ID, \
                                                "w", \
                                                issuerTariffId);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetCO2Value
 * @param startTime int32u
 * @param numberOfEvents int8u
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterSswgGetCO2Value(startTime, \
                                                      numberOfEvents, \
                                                      tariffType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_C_O2_VALUE_COMMAND_ID, \
                                                "wuu", \
                                                startTime, \
                                                numberOfEvents, \
                                                tariffType);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetBillingPeriod
 * @param startTime int32u
 * @param numberOfEvents int8u
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterSswgGetBillingPeriod(startTime, \
                                                           numberOfEvents, \
                                                           tariffType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_BILLING_PERIOD_COMMAND_ID, \
                                                "wuu", \
                                                startTime, \
                                                numberOfEvents, \
                                                tariffType);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetConsolidatedBill
 * @param startTime int32u
 * @param numberOfEvents int8u
 * @param tariffType int8u
 */
#define emberAfFillCommandPriceClusterSswgGetConsolidatedBill(startTime, \
                                                              numberOfEvents, \
                                                              tariffType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_CONSOLIDATED_BILL_COMMAND_ID, \
                                                "wuu", \
                                                startTime, \
                                                numberOfEvents, \
                                                tariffType);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgCppEventResponse
 * @param issuerEventId int32u
 * @param cppAuth int8u
 */
#define emberAfFillCommandPriceClusterSswgCppEventResponse(issuerEventId, \
                                                           cppAuth) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CPP_EVENT_RESPONSE_COMMAND_ID, \
                                                "wu", \
                                                issuerEventId, \
                                                cppAuth);
 ...
 *
 * Cluster: Price, The Price Cluster provides the mechanism for communicating Gas, Energy, or Water pricing information within the premise.
 * Command: SswgGetCurrencyConversionCommand
 * @param issuerEventId int32u
 */
#define emberAfFillCommandPriceClusterSswgGetCurrencyConversionCommand(issuerEventId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PRICE_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_CURRENCY_CONVERSION_COMMAND_COMMAND_ID, \
                                                "w", \
                                                issuerEventId);
...
/** @brief Command description for SswgMessageConfirmation
 *
 * Cluster: Messaging, This cluster provides an interface for passing text messages between SE devices.
 * Command: SswgMessageConfirmation
 * @param messageId int32u
 * @param confirmationTime int32u
 * @param messageConfirmationContral int8u
 * @param messageResponse int8u*
 */
#define emberAfFillCommandMessagingClusterSswgMessageConfirmation(messageId, \
                                                                  confirmationTime, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_MESSAGING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_MESSAGE_CONFIRMATION_COMMAND_ID, \
                                                "wwus", \
                                                messageId, \
                                                confirmationTime, \
                                                messageConfirmationContral, \
 ...
 *
 * Cluster: Tunneling, The tunneling cluster provides an interface for tunneling protocols.
 * Command: SswgGetSupportedTunnelProtocols
 * @param protocolOffset int8u
 */
#define emberAfFillCommandTunnelingClusterSswgGetSupportedTunnelProtocols(protocolOffset) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_TUNNELING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_SUPPORTED_TUNNEL_PROTOCOLS_COMMAND_ID, \
                                                "u", \
                                                protocolOffset);
 ...
 *
 * Cluster: Tunneling, The tunneling cluster provides an interface for tunneling protocols.
 * Command: SswgSupportedTunnelProtocolsResponse
 * @param protocolListComplete int8u
 * @param protocolCount int8u
 * @param protocol int8u*
 * @param protocolLen int16u
 */
#define emberAfFillCommandTunnelingClusterSswgSupportedTunnelProtocolsResponse(protocolListComplete, \
                                                                               protocolCount, \
                                                                               protocol, \
                                                                               protocolLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TUNNELING_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_SUPPORTED_TUNNEL_PROTOCOLS_RESPONSE_COMMAND_ID, \
                                                "uub", \
                                                protocolListComplete, \
                                                protocolCount, \
                                                protocol, \
 ...
 * Command: SswgSelectAvailableEmergencyCredit
 * @param commandIssueDateTime int32u
 * @param originatingDevice int8u
 */
#define emberAfFillCommandPrepaymentClusterSswgSelectAvailableEmergencyCredit(commandIssueDateTime, \
                                                                              originatingDevice) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ...
                                                0xAAAA, \
                                                ZCL_SSWG_SELECT_AVAILABLE_EMERGENCY_CREDIT_COMMAND_ID, \
                                                "wu", \
 ...
 * @param debtRecoveryFrequency int32u
 * @param debtRecoveryAmount int32u
 * @param debtRecoveryBalancePercentage int16u
 * @param debtRecoveryMaxMissed int8u
 * @param signatureType int8u
 * @param signature int8u*
 */
#define emberAfFillCommandPrepaymentClusterSswgChangeDebt(commandIssueDateTime, \
                                                          debtLabel, \
                                                          debtAmount, \
                                                          debtRecoveryMethod, \
                                                          debtType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CHANGE_DEBT_COMMAND_ID, \
                                                "wswuuwvwwvuus", \
                                                commandIssueDateTime, \
                                                debtLabel, \
                                                debtAmount, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgEmergencyCreditSetup
 * @param issuerEventId int32u
 * @param commandIssueDateTime int32u
 * @param emergencyCreditLimit int32u
 * @param emergencyCreditThreshold int32u
 */
#define emberAfFillCommandPrepaymentClusterSswgEmergencyCreditSetup(issuerEventId, \
                                                                    commandIssueDateTime, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_EMERGENCY_CREDIT_SETUP_COMMAND_ID, \
                                                "wwww", \
                                                issuerEventId, \
                                                commandIssueDateTime, \
                                                emergencyCreditLimit, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgConsumerTopUp
 * @param originatingDevice int8u
 * @param topUpCode int8u*
 */
#define emberAfFillCommandPrepaymentClusterSswgConsumerTopUp(originatingDevice, \
                                                             topUpCode) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CONSUMER_TOP_UP_COMMAND_ID, \
                                                "us", \
                                                originatingDevice, \
                                                topUpCode);
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgCreditAdjustment
 * @param issuerEventId int32u
 * @param startTime int32u
 * @param creditAdjustmentType int8u
 * @param creditAdjustmentValue int8u*
 * @param signatureType int8u
 * @param signature int8u*
 */
#define emberAfFillCommandPrepaymentClusterSswgCreditAdjustment(issuerEventId, \
                                                                startTime, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CREDIT_ADJUSTMENT_COMMAND_ID, \
                                                "wwu6us", \
                                                issuerEventId, \
                                                startTime, \
                                                creditAdjustmentType, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgChangePaymentMode
 * @param supplierId int32u
 * @param issuerEventId int32u
 * @param implementationDateTime int32u
 * @param proposedPaymentControl int16u
 * @param cuttOffValue int32s
 * @param signatureType int8u
 * @param signature int8u*
 */
#define emberAfFillCommandPrepaymentClusterSswgChangePaymentMode(supplierId, \
                                                                 issuerEventId, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CHANGE_PAYMENT_MODE_COMMAND_ID, \
                                                "wwwvwus", \
                                                supplierId, \
                                                issuerEventId, \
                                                implementationDateTime, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgGetPrepaySnapshot
 * @param startTime int32u
 * @param numberOfSnapshots int8u
 * @param snapshotCause int16u
 */
#define emberAfFillCommandPrepaymentClusterSswgGetPrepaySnapshot(startTime, \
                                                                 numberOfSnapshots, \
                                                                 snapshotCause) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_PREPAY_SNAPSHOT_COMMAND_ID, \
                                                "wuv", \
                                                startTime, \
                                                numberOfSnapshots, \
                                                snapshotCause);
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgGetTopUpLog
 * @param numberOfEvents int8u
 */
#define emberAfFillCommandPrepaymentClusterSswgGetTopUpLog(numberOfEvents) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_TOP_UP_LOG_COMMAND_ID, \
                                                "u", \
                                                numberOfEvents);
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgSetLowCreditWarningLevel
 * @param lowCreditWarningLevel int32u
 */
#define emberAfFillCommandPrepaymentClusterSswgSetLowCreditWarningLevel(lowCreditWarningLevel) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_SET_LOW_CREDIT_WARNING_LEVEL_COMMAND_ID, \
                                                "w", \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgGetDebtRepaymentyLog
 * @param numberOfDebt int8u
 * @param debtType int8u
 */
#define emberAfFillCommandPrepaymentClusterSswgGetDebtRepaymentyLog(numberOfDebt, \
                                                                    debtType) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_DEBT_REPAYMENTY_LOG_COMMAND_ID, \
                                                "uu", \
                                                numberOfDebt, \
                                                debtType);
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgGetPrepaySnapshotResponse
 * @param issuerEventId int32u
 * @param snapshotTime int32u
 * @param commandIndex int8u
 * @param snapshotCause int16u
 ...
 * @param snapshotPayloadLen int16u
 */
#define emberAfFillCommandPrepaymentClusterSswgGetPrepaySnapshotResponse(issuerEventId, \
                                                                         snapshotTime, \
                                                                         commandIndex, \
                                                                         snapshotCause, \
                                                                         snapshotPayloadType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_PREPAY_SNAPSHOT_RESPONSE_COMMAND_ID, \
                                                "wwuvub", \
                                                issuerEventId, \
                                                snapshotTime, \
                                                commandIndex, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgChangePaymentModeResponse
 * @param friendlyCredit int8u
 * @param friendlyCreditCalendarId int32u
 * @param emergencyCreditLimit int32u
 * @param emergencyCreditThreshold int32u
 */
#define emberAfFillCommandPrepaymentClusterSswgChangePaymentModeResponse(friendlyCredit, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CHANGE_PAYMENT_MODE_RESPONSE_COMMAND_ID, \
                                                "uwww", \
                                                friendlyCredit, \
                                                friendlyCreditCalendarId, \
                                                emergencyCreditLimit, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgConsumerTopUpResponse
 * @param resultType int8u
 * @param topUpValue int32s
 * @param sourceOfTopUp int8u
 * @param creditRemaining int32s
 */
#define emberAfFillCommandPrepaymentClusterSswgConsumerTopUpResponse(resultType, \
                                                                     topUpValue, \
                                                                     sourceOfTopUp, \
                                                                     creditRemaining) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CONSUMER_TOP_UP_RESPONSE_COMMAND_ID, \
                                                "uwuw", \
                                                resultType, \
                                                topUpValue, \
                                                sourceOfTopUp, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgGetCommand
 * @param prePayNotificationFlags int16u
 */
#define emberAfFillCommandPrepaymentClusterSswgGetCommand(prePayNotificationFlags) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_COMMAND_COMMAND_ID, \
                                                "v", \
                                                prePayNotificationFlags);
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgPublishTopUpLog
 * @param commandIndex int8u
 * @param totalNumberOfCommands int8u
 * @param topUpCodes int8u*
 * @param topUpCodesLen int16u
 */
#define emberAfFillCommandPrepaymentClusterSswgPublishTopUpLog(commandIndex, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_TOP_UP_LOG_COMMAND_ID, \
                                                "uub", \
                                                commandIndex, \
                                                totalNumberOfCommands, \
                                                topUpCodes, \
 ...
 *
 * Cluster: Prepayment, The Prepayment Cluster provides the facility to pass messages relating to prepayment between devices on the HAN.
 * Command: SswgPublishDebtLog
 * @param commandIndex int8u
 * @param totalNumberOfCommands int8u
 * @param debtPayload int8u*
 * @param debtPayloadLen int16u
 */
#define emberAfFillCommandPrepaymentClusterSswgPublishDebtLog(commandIndex, \
                                                              totalNumberOfCommands, \
                                                              debtPayload, \
                                                              debtPayloadLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_PREPAYMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_DEBT_LOG_COMMAND_ID, \
                                                "uub", \
                                                commandIndex, \
                                                totalNumberOfCommands, \
                                                debtPayload, \
...
// @{
/** @brief The PublishCalendar command is sent in response to a GetCalendar command or if new calendar information is available.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgPublishCalendar
 * @param providerId int32u
 * @param issuerEventId int32u
 ...
 */
#define emberAfFillCommandTouCalendarClusterSswgPublishCalendar(providerId, \
                                                                issuerEventId, \
                                                                issuerCalendarId, \
                                                                startTime, \
                                                                calendarType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CALENDAR_COMMAND_ID, \
                                                "wwwwusuuu", \
                                                providerId, \
                                                issuerEventId, \
                                                issuerCalendarId, \
...
/** @brief The PublishDayProfile command is sent in response to a GetDayProfile command.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgPublishDayProfile
 * @param providerId int32u
 * @param issuerEventId int32u
 * @param issuerCalendarId int32u
 * @param dayId int8u
 ...
 */
#define emberAfFillCommandTouCalendarClusterSswgPublishDayProfile(providerId, \
                                                                  issuerEventId, \
                                                                  issuerCalendarId, \
                                                                  dayId, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_DAY_PROFILE_COMMAND_ID, \
                                                "wwwuuuub", \
                                                providerId, \
                                                issuerEventId, \
                                                issuerCalendarId, \
...
/** @brief The PublishWeekProfile command is sent in response to a GetWeekProfile command.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgPublishWeekProfile
 * @param providerId int32u
 * @param issuerEventId int32u
 * @param issuerCalendarId int32u
 * @param weekId int8u
 ...
 */
#define emberAfFillCommandTouCalendarClusterSswgPublishWeekProfile(providerId, \
                                                                   issuerEventId, \
                                                                   issuerCalendarId, \
                                                                   weekId, \
                                                                   dayIdRefMonday, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_WEEK_PROFILE_COMMAND_ID, \
                                                "wwwuuuuuuuu", \
                                                providerId, \
                                                issuerEventId, \
                                                issuerCalendarId, \
...
/** @brief The PublishSeasons command is sent in response to a GetSeason command.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgPublishSeasons
 * @param providerId int32u
 * @param issuerEventId int32u
 * @param issuerCalendarId int32u
 * @param commandIndex int8u
 ...
 */
#define emberAfFillCommandTouCalendarClusterSswgPublishSeasons(providerId, \
                                                               issuerEventId, \
                                                               issuerCalendarId, \
                                                               commandIndex, \
                                                               totalCommands, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_SEASONS_COMMAND_ID, \
                                                "wwwuub", \
                                                providerId, \
                                                issuerEventId, \
                                                issuerCalendarId, \
...
/** @brief The PublishSpecialDays command is sent in response to a GetSpecialDays command or if a calendar update is available.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgPublishSpecialDays
 * @param providerId int32u
 * @param issuerEventId int32u
 * @param startTime int32u
 * @param calendarType int8u
 ...
 */
#define emberAfFillCommandTouCalendarClusterSswgPublishSpecialDays(providerId, \
                                                                   issuerEventId, \
                                                                   startTime, \
                                                                   calendarType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_SPECIAL_DAYS_COMMAND_ID, \
                                                "wwwuuuub", \
                                                providerId, \
                                                issuerEventId, \
                                                startTime, \
...
/** @brief This command initiates a PublishCalendar command for the scheduled TOU Calendar updates.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgGetCalendar
 * @param startTime int32u
 * @param minimumIssuerEventId int32u
 * @param numberOfCalendars int8u
 * @param calendarType int8u
 * @param providerId int32u
 */
#define emberAfFillCommandTouCalendarClusterSswgGetCalendar(startTime, \
                                                            minimumIssuerEventId, \
                                                            numberOfCalendars, \
                                                            calendarType, \
                                                            providerId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_CALENDAR_COMMAND_ID, \
                                                "wwuuw", \
                                                startTime, \
                                                minimumIssuerEventId, \
                                                numberOfCalendars, \
...
/** @brief This command initiates one or more PublishDayProfile command for the referenced TOU Calendar.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgGetDayProfiles
 * @param providerId int32u
 * @param issuerCalendarId int32u
 * @param dayId int8u
 * @param numberOfDays int8u
 */
#define emberAfFillCommandTouCalendarClusterSswgGetDayProfiles(providerId, \
                                                               issuerCalendarId, \
                                                               dayId, \
                                                               numberOfDays) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_DAY_PROFILES_COMMAND_ID, \
                                                "wwuu", \
                                                providerId, \
                                                issuerCalendarId, \
                                                dayId, \
...
/** @brief This command initiates one or more PublishWeekProfile command for the referenced TOU Calendar.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgGetWeekProfiles
 * @param providerId int32u
 * @param issuerCalendarId int32u
 * @param weekId int8u
 * @param numberOfWeeks int8u
 */
#define emberAfFillCommandTouCalendarClusterSswgGetWeekProfiles(providerId, \
                                                                issuerCalendarId, \
                                                                weekId, \
                                                                numberOfWeeks) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_WEEK_PROFILES_COMMAND_ID, \
                                                "wwuu", \
                                                providerId, \
                                                issuerCalendarId, \
                                                weekId, \
...
/** @brief This command initiates one or more PublishSeasons command for the referenced TOU Calendar.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgGetSeasons
 * @param providerId int32u
 * @param issuerCalendarId int32u
 */
#define emberAfFillCommandTouCalendarClusterSswgGetSeasons(providerId, \
                                                           issuerCalendarId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_SEASONS_COMMAND_ID, \
                                                "ww", \
                                                providerId, \
                                                issuerCalendarId);


/** @brief This command initiates one or more PublishSpecialDay command for the scheduled Special Day Table updates.
 *
 * Cluster: TOU Calendar, TOU Calendar cluster
 * Command: SswgGetSpecialDays
 * @param startTime int32u
 * @param numberOfEvents int8u
 * @param calendarType int8u
 * @param providerId int32u
 * @param issuerCalendarId int32u
 */
#define emberAfFillCommandTouCalendarClusterSswgGetSpecialDays(startTime, \
                                                               numberOfEvents, \
                                                               calendarType, \
                                                               providerId, \
                                                               issuerCalendarId) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_TOU_CALENDAR_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_SPECIAL_DAYS_COMMAND_ID, \
                                                "wuuww", \
                                                startTime, \
                                                numberOfEvents, \
                                                calendarType, \
 ...
 * Command: SswgGetChangeOfTenancy
 */
#define emberAfFillCommandDeviceManagementClusterSswgGetChangeOfTenancy() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_CHANGE_OF_TENANCY_COMMAND_ID, \
                                                "");
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgGetChangeOfSupplier
 */
#define emberAfFillCommandDeviceManagementClusterSswgGetChangeOfSupplier() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_CHANGE_OF_SUPPLIER_COMMAND_ID, \
                                                "");
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgGetChangeSupply
 */
#define emberAfFillCommandDeviceManagementClusterSswgGetChangeSupply() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_CHANGE_SUPPLY_COMMAND_ID, \
                                                "");
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgSupplyStatusResponse
 * @param supplierId int32u
 * @param issuerEventId int32u
 * @param implementationDateTime int32u
 * @param supplyStatus int8u
 */
#define emberAfFillCommandDeviceManagementClusterSswgSupplyStatusResponse(supplierId, \
                                                                          issuerEventId, \
                                                                          implementationDateTime, \
                                                                          supplyStatus) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_SUPPLY_STATUS_RESPONSE_COMMAND_ID, \
                                                "wwwu", \
                                                supplierId, \
                                                issuerEventId, \
                                                implementationDateTime, \
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgGetPassword
 * @param passwordLevel int8u
 */
#define emberAfFillCommandDeviceManagementClusterSswgGetPassword(passwordLevel) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_GET_PASSWORD_COMMAND_ID, \
                                                "u", \
                                                passwordLevel);
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgPublishChangeOfTenancy
 * @param supplierId int32u
 * @param issuerEventId int32u
 * @param tariffType int8u
 * @param implementationDateTime int32u
 ...
 * @param signature int8u*
 */
#define emberAfFillCommandDeviceManagementClusterSswgPublishChangeOfTenancy(supplierId, \
                                                                            issuerEventId, \
                                                                            tariffType, \
                                                                            implementationDateTime, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CHANGE_OF_TENANCY_COMMAND_ID, \
                                                "wwuwwus", \
                                                supplierId, \
                                                issuerEventId, \
                                                tariffType, \
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgPublishChangeOfSupplier
 ...
 * @param signature int8u*
 */
#define emberAfFillCommandDeviceManagementClusterSswgPublishChangeOfSupplier(currentSupplierId, \
                                                                             issuerEventId, \
                                                                             tariffType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_PUBLISH_CHANGE_OF_SUPPLIER_COMMAND_ID, \
                                                "wwuwwwsus", \
                                                currentSupplierId, \
                                                issuerEventId, \
                                                tariffType, \
 ...
 * @param signature int8u*
 */
#define emberAfFillCommandDeviceManagementClusterSswgChangeSupply(supplierId, \
                                                                  issuerEventId, \
                                                                  requestedDateTime, \
                                                                  implementationDateTime, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CHANGE_SUPPLY_COMMAND_ID, \
                                                "wwwwuuus", \
                                                supplierId, \
                                                issuerEventId, \
                                                requestedDateTime, \
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgChangePassword
 * @param passwordLevel int8u
 * @param password int8u*
 */
#define emberAfFillCommandDeviceManagementClusterSswgChangePassword(passwordLevel, \
                                                                    password) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_CHANGE_PASSWORD_COMMAND_ID, \
                                                "us", \
                                                passwordLevel, \
                                                password);
 ...
 *
 * Cluster: Device Management, Device Management cluster
 * Command: SswgLocalChangeSupply
 * @param proposedSupplyStatus int8u
 */
#define emberAfFillCommandDeviceManagementClusterSswgLocalChangeSupply(proposedSupplyStatus) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_LOCAL_CHANGE_SUPPLY_COMMAND_ID, \
                                                "u", \
                                                proposedSupplyStatus);
 ...
 * @param signature int8u*
 */
#define emberAfFillCommandDeviceManagementClusterSswgUpdateSiteId(issuerEventId, \
                                                                  siteIdTime, \
                                                                  supplierId, \
                                                                  siteId, \
                                                                  signatureType, \
  ...
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                ...
                                                ZCL_DEVICE_MANAGEMENT_CLUSTER_ID, \
                                                0xAAAA, \
                                                ZCL_SSWG_UPDATE_SITE_ID_COMMAND_ID, \
                                                "wwwsus", \
                                                issuerEventId, \
                                                siteIdTime, \
                                                supplierId, \
