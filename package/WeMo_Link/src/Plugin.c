...
int main(int argc, char **argv )
{
  ...
  /*RG-App specific functions should be handled in App Init functions - TODO (Talk to team)*/
  SD_OpenInterface();

  core_init_early();
  // restoreRelayState();

  /*RG- App specific init should see whether to init or not the APNS. TODO: Remove the following line.*/
  //InitAPNS();
