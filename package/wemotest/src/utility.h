...
char*   createCommand(int command);


char* readScriptResult(char* script, char* dest, int size, int isReadAll/*0x00, NO, just first line*/);

char* createPayloadStr(char* dest, char*);
