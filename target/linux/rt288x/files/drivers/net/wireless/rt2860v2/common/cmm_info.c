...
#endif /* WSC_STA_SUPPORT */
#endif /* CONFIG_STA_SUPPORT */
//WNC0_tsunghao Thu 05 Sep 2013 10:05:30 PM CST
enum {
    SITE_SURVEY_SSID_MATCH,
    SITE_SURVEY_SSID_NOT_MATCH
};
extern UCHAR g_SiteSurvey_SSID[MAX_LEN_OF_SSID + 1];
//VOID	RTMPCommSiteSurveyData(
int	RTMPCommSiteSurveyData(
//WNC0
	IN  PSTRING		msg,
	IN  PBSS_ENTRY	pBss,
	IN  UINT32		MsgLen)
...
//WNC0_tsunghao Thu 05 Sep 2013 10:12:00 PM CST
	BOOLEAN bSiteSurveySingleSSID = (strcmp(g_SiteSurvey_SSID, "1") == 0)?FALSE:TRUE;

    if(bSiteSurveySingleSSID) {
        if(strcmp(pBss->Ssid, g_SiteSurvey_SSID))
            return SITE_SURVEY_SSID_NOT_MATCH;
    }
//WNC0
...
//WNC0_tsunghao Thu 05 Sep 2013 10:54:11 PM CST
//	return;
	return SITE_SURVEY_SSID_MATCH;
//WNC0
}
...
//WNC0_tsunghao Thu 05 Sep 2013 10:51:58 PM CST
//		RTMPCommSiteSurveyData(msg, pBss, TotalLen);
		if (RTMPCommSiteSurveyData(msg, pBss, TotalLen) == SITE_SURVEY_SSID_NOT_MATCH)
            continue;
//WNC0
