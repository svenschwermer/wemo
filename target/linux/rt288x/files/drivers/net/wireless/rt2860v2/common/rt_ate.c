...
//WNC0_tsunghao Mon 18 Nov 2013 10:02:47 AM CST, Ralink's patch for offset 0x76 change to 0x90ff after calibration
//		EEPData = (EEPData2 << 8) | (TSSI_x_h.delta << 4) | TSSI_x_l.delta;
        EEPData = TSSI_x_l.delta;
        EEPData &= 0x000f;
        EEPData |= TSSI_x_h.delta << 4;
        EEPData &= 0x00ff;
        EEPData |= EEPData2 << 8;
//WNC0
