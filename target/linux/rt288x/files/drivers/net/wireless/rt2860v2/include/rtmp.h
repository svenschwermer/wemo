...
#define TIME_ONE_SECOND		(1000000/TIME_BASE)
	...
	UCHAR   SpecBeaconIE[128];
	UINT32  SpecBeaconIELenth;
	BOOLEAN bSetSpecBeaconIE;
	UCHAR   SpecAssocRspIE[128];
	UINT32  SpecAssocRspIELenth;
	BOOLEAN bSetSpecAssocRspIE;
	UCHAR   SpecProbeRspIE[128];
	UINT32  SpecProbeRspIELenth;
	BOOLEAN bSetSpecProbeRspIE;

	UCHAR	SpecOUI[8];
	UINT32  SpecOUILength;
