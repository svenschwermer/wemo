...
UCHAR g_SiteSurvey_SSID[MAX_LEN_OF_SSID + 1];
//WNC0
...
//WNC0_tsunghao Thu 05 Sep 2013 10:06:12 PM CST
            memset(g_SiteSurvey_SSID, 0, sizeof(g_SiteSurvey_SSID));
            NdisZeroMemory(g_SiteSurvey_SSID, (MAX_LEN_OF_SSID +1));
            NdisMoveMemory(g_SiteSurvey_SSID, Ssid.Ssid, Ssid.SsidLength );
            printk("[%s] g_SiteSurvey_SSID = %s\n", __func__, g_SiteSurvey_SSID );
//WNC0
		}
