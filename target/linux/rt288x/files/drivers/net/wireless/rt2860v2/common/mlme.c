	...
	IN PRTMP_ADAPTER pAd) 
{
	...
	do 
	{
		...
		IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
		{
			...
			RTMPInitTimer(pAd, &pAd->ApCliMlmeAux.WpaDisassocAndBlockAssocTimer, GET_TIMER_FUNCTION(ApCliWpaDisassocApAndBlockAssoc), pAd, FALSE);
	...
	IN PRTMP_ADAPTER pAd) 
{
	...
	IF_DEV_CONFIG_OPMODE_ON_AP(pAd)
	{
		...
		RTMPCancelTimer(&pAd->ApCliMlmeAux.WpaDisassocAndBlockAssocTimer, &Cancelled);
