...
//WNC0_tsunghao Thu 13 Feb 2014 02:35:43 PM CST, Ralink patch for WFA client 5.2.48 20/40 coex
//	ActHeaderInit(pAd, &Frame.Hdr, pAd->MacTab.Content[Wcid].Addr, pAd->CurrentAddress, pAd->CommonCfg.Bssid);	
    ...
    {               
        ActHeaderInit(pAd, &Frame.Hdr, pAd->MacTab.Content[Wcid].Addr, pAd->ApCfg.ApCliTab[0].CurrentAddress, pAd->MacTab.Content[Wcid].Addr);            
